...
int MissionNetworkBattle08::processtimer (Uint32 dt)
    ...
    if (MissionStateNetworkBattle == 2 && (timer > PriorStateEndTimer +1100))
       ...
       //
       if (MyNetworkId%2)
          { //  RedTeam MissionNetworkBattle08
          if (ThreeDObjects[MissionObjectHqRed]->Durability < ThreeDObjects[MissionObjectHqRed]->maxDurability * 0.4)
             ...
             if (fplayer->HistoricPeriod > 1)
                { //  Get here if the player is flying a late-war or postwar aircraft in this MissionNetworkBattle08
          ...
          { //  BlueTeam MissionNetworkBattle08
    ...
    if (MissionNetworkBattle08Timer > 1000)
    ...
    if (NetworkReceiveTimer > NetworkReceiveTimerInterval )
       ...
       if (BytesReceived == sizeof (LacUdpApiPacket))
          ...
          if (MissionNetworkBattle08PriorAircraft[InPacket.UdpObjPlayerNumber] != InPacket.UdpObjVehicle)
