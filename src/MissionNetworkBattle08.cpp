...
//
//  This file implements "MissionNetworkBattle08".
//
...
//
float RedTeamCarrier08XPositionAtMilestone1 = 272.105042;
float RedTeamCarrier08ZPositionAtMilestone1 = -76.429771;
float RedTeamCarrier08PhiAtMilestone1 = 246.202545;
float RedTeamCarrier08XPositionAtMilestone2 = 260.318420;
float RedTeamCarrier08ZPositionAtMilestone2 = -136.597427;
float RedTeamCarrier08PhiAtMilestone2 = 315.804138;
float RedTeamCarrier08XPositionAtMilestone3 = 266.714844;
float RedTeamCarrier08ZPositionAtMilestone3 = -66.925232;
float RedTeamCarrier08PhiAtMilestone3 = 234.528992;
float RedTeamCarrier08XPositionAtMilestone4 = 198.952469;
float RedTeamCarrier08ZPositionAtMilestone4 = -49.964832;
float RedTeamCarrier08PhiAtMilestone4 = 153.413849;
float RedTeamCarrier08XPositionAtMilestone5 = 171.683975;
float RedTeamCarrier08ZPositionAtMilestone5 = -114.148750;
float RedTeamCarrier08PhiAtMilestone5 = 72.458717;
float RedTeamCarrier08XPositionAtMilestone6 = 231.078461;
float RedTeamCarrier08ZPositionAtMilestone6 = -151.122269;
float RedTeamCarrier08PhiAtMilestone6 = 351.185089;
float RedTeamCarrier08XPositionAtMilestone7 = 276.633148;
float RedTeamCarrier08ZPositionAtMilestone7 = -98.321991;
float RedTeamCarrier08PhiAtMilestone7 = 270.229950;
float RedTeamCarrier08XPositionAtMilestone8 = 230.909607;
float RedTeamCarrier08ZPositionAtMilestone8 = -44.914185;
float RedTeamCarrier08PhiAtMilestone8 = 188.474792;
float RedTeamCarrier08XPositionAtMilestone9 = 171.672470;
float RedTeamCarrier08ZPositionAtMilestone9 = -81.931099;
float RedTeamCarrier08PhiAtMilestone9 = 107.359657;
float RedTeamCarrier08XPositionAtMilestone10 = 198.961212;
float RedTeamCarrier08ZPositionAtMilestone10 = -146.105331;
float RedTeamCarrier08PhiAtMilestone10 = 26.405413;

float BlueTeamCarrier08XPositionAtMilestone1 = -239.394958;
float BlueTeamCarrier08ZPositionAtMilestone1 = -76.429771;
float BlueTeamCarrier08PhiAtMilestone1 = 246.202545;
float BlueTeamCarrier08XPositionAtMilestone2 = -251.181580;
float BlueTeamCarrier08ZPositionAtMilestone2 = -136.597427;
float BlueTeamCarrier08PhiAtMilestone2 = 315.804138;
float BlueTeamCarrier08XPositionAtMilestone3 = -244.785156;
float BlueTeamCarrier08ZPositionAtMilestone3 = -66.925232;
float BlueTeamCarrier08PhiAtMilestone3 = 234.528992;
float BlueTeamCarrier08XPositionAtMilestone4 = -312.547516;
float BlueTeamCarrier08ZPositionAtMilestone4 = -49.964832;
float BlueTeamCarrier08PhiAtMilestone4 = 153.413849;
float BlueTeamCarrier08XPositionAtMilestone5 = -339.816040;
float BlueTeamCarrier08ZPositionAtMilestone5 = -114.148750;
float BlueTeamCarrier08PhiAtMilestone5 = 72.458717;
float BlueTeamCarrier08XPositionAtMilestone6 = -280.421539;
float BlueTeamCarrier08ZPositionAtMilestone6 = -151.122269;
float BlueTeamCarrier08PhiAtMilestone6 = 351.185089;
float BlueTeamCarrier08XPositionAtMilestone7 = -234.866852;
float BlueTeamCarrier08ZPositionAtMilestone7 = -98.321991;
float BlueTeamCarrier08PhiAtMilestone7 = 270.229950;
float BlueTeamCarrier08XPositionAtMilestone8 = -280.590393;
float BlueTeamCarrier08ZPositionAtMilestone8 = -44.914185;
float BlueTeamCarrier08PhiAtMilestone8 = 188.474792;
float BlueTeamCarrier08XPositionAtMilestone9 = -339.827545;
float BlueTeamCarrier08ZPositionAtMilestone9 = -81.931099;
float BlueTeamCarrier08PhiAtMilestone9 = 107.359657;
float BlueTeamCarrier08XPositionAtMilestone10 = -312.538788;
float BlueTeamCarrier08ZPositionAtMilestone10 = -146.105331;
float BlueTeamCarrier08PhiAtMilestone10 = 26.405413;

float MissionObjectCarrierBlue1RudderDegreesM08 = 0.16;
float MissionObjectCarrierBlue1ThrustM08 = 0.15;
float MissionObjectCarrierRed1RudderDegreesM08 = 0.16;
float MissionObjectCarrierRed1ThrustM08 = 0.15;

//
// Mission-specific code commences here:
//
MissionNetworkBattle08::MissionNetworkBattle08() {
    //
    ...
    //
    display((char*)"MissionNetworkBattle08::MissionNetworkBattle08()", LOG_MOST);
    id = MISSION_NETWORKBATTLE08;
    if ((NetworkMode & 1) == 0) {
        strncpy(name, "WRONG NETWORK MODE!", 1024);
        strncpy(briefing, "LACCONFIG.TXT FILE MUST SET MODE 1, 3, OR 5 AND A SERVER ADDRESS.", 1024);
    } else {
        strncpy(name, "NETWORK MISSION 08 (BETA TEST)", 1024);
    ...
    if ((NetworkMode & 1) == 1) { //  ClientServer mode requires only a single UDP port, used both for sending and receiving
        display((char*)"Attempting MissionNetworkBattle08 in ClientServer Network mode.", LOG_NET);
        if (OpenClientUdpSocket() == 0) { //  Get here if we were able to open the required ClientServer UDP Socket
            display((char*)"MissionNetworkBattle08 ClientServer mode succesfully opened ClientUDP socket", LOG_NET);
            ConfigureClientUdpSocket();
        } else { //  Get here if we were unable to open the required ClientUDP socket
            display((char*)"MissionNetworkBattle08 ClientServer mode unable to open ClientUDP socket.", LOG_NET);
        }
    } else {
    ...
    //
    event_CommsMacro17();
} //  end MissionNetworkBattle08::MissionNetworkBattle08 ()

void MissionNetworkBattle08::start() {
    ...
    //
    display((char*)"MissionNetworkBattle08::start setting PlayerAircraftType to: ", LOG_MOST);
    ...
    for (i = 1; i <= 10; i++) {
        ...
        MissionNetworkBattle08PriorAircraft[i] = FIGHTER_F4F;
        //
        ...
        //
        sprintf(DebugBuf, "MissionNetworkBattle08::start() initializing Bot #%d", i);
        display(DebugBuf, LOG_MOST);
        sprintf(
            DebugBuf,
            "MissionNetworkBattle08::start() ThreeDObjects [i]->MyMissionPlayerNumber = %d",
...
} //  end MissionNetworkBattle08::start ()

int MissionNetworkBattle08::processtimer(Uint32 dt) {
    ...
    //  this mission:
    //
    MissionNetworkBattle08Timer += DeltaTime; //  Advance by milliseconds
    ...
    if (!MissionRunning) { //  Get here if this is the FIRST pass through processtimer().
        ...
        */
        ...
        if (fplayer->missiles[0] >= 4 || fplayer->id == FIGHTER_D3A || fplayer->id == BOMBER_B5N) { //  Heavy bombers need more initial altitude and distance to avoid stalling and crashing...
            fplayer->tl->y += 60;
            sprintf(DebugBuf, "MissionNetworkBattle08::processtimer() Heavy bomber launching. AirfieldRequested = %d", AirfieldRequested);
            display(DebugBuf, LOG_MOST);
            if (AirfieldRequested >= 3) { //  Get here if launching from the most remote airfield (in a heavy bomber).
                display((char*)"MissionNetworkBattle08::processtimer() Increasing heavy bomber spawn altitude from Field 4", LOG_MOST);
 ...
 //
    ...
    if (timer > 10000 && MissionStateNetworkBattle == 0 && NetworkTransmitTimer >= NetworkTransmitTimerInterval) { //  Only get here once, 10 seconds into the mission, as we've just begun transmitting OutPackets
        ...
        MissionObjectCarrierRed1RudderDegreesM08 = 0.16;
        MissionObjectCarrierRed1ThrustM08 = 0.150;
    ...
    if (MissionStateNetworkBattle == 2 && (timer > PriorStateEndTimer + 1100)) { //  Only get here once, 1100 sec after MissionStateNetworkBattle
        ...
        //
        if (MyNetworkId % 2) { //  RedTeam MissionNetworkBattle08
            if (ThreeDObjects[MissionObjectHqRed]->Durability < ThreeDObjects[MissionObjectHqRed]->maxDurability * 0.4) { //  Get here if player's RedTeam HQ is heavily damaged. Diminish fuel/armament for late-war aircraft.
                display((char*)"MissionNetworkBattle08 state 2: Player's RedTeam HQ is heavily damaged.", LOG_MOST);
                if (fplayer->HistoricPeriod > 1) { //  Get here if the player is flying a late-war or postwar aircraft in this MissionNetworkBattle08
                    ...
                    for (i2 = 0; i2 < missiletypes; i2++) {
                        if (i2 == 0) { //  Rack0 = BOMB01
                            ...
                            display((char*)"MissionNetworkBattle08::processtimer() diminishing RedTeam late-war bomb load due to heavy HQ airfield damage", LOG_MOST);
                        }
                        if (i2 == 5) { //  Rack5 = DFM Rockets
                            fplayer->missiles[i2] /= 3;
                            display((char*)"MissionNetworkBattle08::processtimer() diminishing RedTeam late-war rocket load due to heavy HQ airfield damage", LOG_MOST);
                        }
                    }
                ...
                display((char*)"MissionNetworkBattle08 state 1: Player's RedTeam HQ is NOT heavily damaged.", LOG_MOST);
                sprintf(SystemMessageBufferA, "OUR HQ FACILITIES PERMIT FULL FUEL/ORDNANCE.");
                NewSystemMessageNeedsScrolling = true;
            }
        } else { //  BlueTeam MissionNetworkBattle08
            if (ThreeDObjects[MissionObjectHqBlue]->Durability < ThreeDObjects[MissionObjectHqBlue]->maxDurability * 0.4) { //  Get here if player's BlueTeam HQ is heavily damaged. Diminish fuel/armament for late-war aircraft.
                if (fplayer->HistoricPeriod > 1) { //  Get here if the player is flying a late-war or postwar aircraft in this MissionNetworkBattle08
                    ...
                    for (i2 = 0; i2 < missiletypes; i2++) {
                        if (i2 == 0) { //  Rack0 = BOMB01
                            fplayer->missiles[i2] /= 3;
                            display((char*)"MissionNetworkBattle08::processtimer() diminishing BlueTeam late-war bomb load due to heavy HQ airfield damage", LOG_MOST);
                        }
                        if (i2 == 5) { //  Rack5 = DFM Rockets
                            fplayer->missiles[i2] /= 3;
                            display((char*)"MissionNetworkBattle08::processtimer() diminishing BlueTeam late-war rocket load due to heavy HQ airfield damage", LOG_MOST);
                        }
                    }
                } else { //  Get here if flying an early-war aircraft.
                    sprintf(SystemMessageBufferA, "WE HAVE FUEL/ORDNANCE FOR THAT AIRCRAFT.");
    ...
    if (MissionStateNetworkBattle == 15 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier08PhiAtMilestone1;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier08XPositionAtMilestone1;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier08ZPositionAtMilestone1;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier08PhiAtMilestone1;
        sprintf(DebugBuf, "MissionNetworkBattle08::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        MissionStateNetworkBattle = 16;
        sprintf(DebugBuf, "MissionNetworkBattle08::processtimer()aa: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * use:
        RedTeamCarrier08XPositionAtMilestone1 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier08ZPositionAtMilestone1 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier08PhiAtMilestone1 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08XPositionAtMilestone1 = %f", RedTeamCarrier08XPositionAtMilestone1);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08ZPositionAtMilestone1 = %f", RedTeamCarrier08ZPositionAtMilestone1);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08PhiAtMilestone1 = %f", RedTeamCarrier08PhiAtMilestone1);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
        // the mission advancing through this MissionState, we adjust "RudderDegrees"
        // and "Thrust" variables here:
    ...
    if (MissionStateNetworkBattle == 20 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier08PhiAtMilestone2;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier08XPositionAtMilestone2;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier08ZPositionAtMilestone2;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier08PhiAtMilestone2;
        sprintf(DebugBuf, "MissionNetworkBattle08::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier08XPositionAtMilestone2 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier08ZPositionAtMilestone2 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier08PhiAtMilestone2 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08XPositionAtMilestone2 = %f", RedTeamCarrier08XPositionAtMilestone2);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08ZPositionAtMilestone2 = %f", RedTeamCarrier08ZPositionAtMilestone2);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08PhiAtMilestone2 = %f", RedTeamCarrier08PhiAtMilestone2);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 40 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier08PhiAtMilestone3;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier08XPositionAtMilestone3;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier08ZPositionAtMilestone3;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier08PhiAtMilestone3;
        sprintf(DebugBuf, "MissionNetworkBattle08::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier08XPositionAtMilestone3 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier08ZPositionAtMilestone3 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier08PhiAtMilestone3 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08XPositionAtMilestone3 = %f", RedTeamCarrier08XPositionAtMilestone3);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08ZPositionAtMilestone3 = %f", RedTeamCarrier08ZPositionAtMilestone3);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08PhiAtMilestone3 = %f", RedTeamCarrier08PhiAtMilestone3);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 60 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier08PhiAtMilestone4;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier08XPositionAtMilestone4;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier08ZPositionAtMilestone4;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier08PhiAtMilestone4;
        sprintf(DebugBuf, "MissionNetworkBattle08::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier08XPositionAtMilestone4 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier08ZPositionAtMilestone4 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier08PhiAtMilestone4 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08XPositionAtMilestone4 = %f", RedTeamCarrier08XPositionAtMilestone4);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08ZPositionAtMilestone4 = %f", RedTeamCarrier08ZPositionAtMilestone4);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08PhiAtMilestone4 = %f", RedTeamCarrier08PhiAtMilestone4);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 80 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier08PhiAtMilestone5;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier08XPositionAtMilestone5;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier08ZPositionAtMilestone5;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier08PhiAtMilestone5;
        sprintf(DebugBuf, "MissionNetworkBattle08::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier08XPositionAtMilestone5 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier08ZPositionAtMilestone5 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier08PhiAtMilestone5 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08XPositionAtMilestone5 = %f", RedTeamCarrier08XPositionAtMilestone5);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08ZPositionAtMilestone5 = %f", RedTeamCarrier08ZPositionAtMilestone5);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08PhiAtMilestone5 = %f", RedTeamCarrier08PhiAtMilestone5);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 100 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier08PhiAtMilestone6;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier08XPositionAtMilestone6;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier08ZPositionAtMilestone6;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier08PhiAtMilestone6;
        sprintf(DebugBuf, "MissionNetworkBattle08::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier08XPositionAtMilestone6 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier08ZPositionAtMilestone6 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier08PhiAtMilestone6 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08XPositionAtMilestone6 = %f", RedTeamCarrier08XPositionAtMilestone6);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08ZPositionAtMilestone6 = %f", RedTeamCarrier08ZPositionAtMilestone6);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08PhiAtMilestone6 = %f", RedTeamCarrier08PhiAtMilestone6);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 120 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier08PhiAtMilestone7;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier08XPositionAtMilestone7;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier08ZPositionAtMilestone7;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier08PhiAtMilestone7;
        sprintf(DebugBuf, "MissionNetworkBattle08::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier08XPositionAtMilestone7 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier08ZPositionAtMilestone7 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier08PhiAtMilestone7 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08XPositionAtMilestone7 = %f", RedTeamCarrier08XPositionAtMilestone7);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08ZPositionAtMilestone7 = %f", RedTeamCarrier08ZPositionAtMilestone7);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08PhiAtMilestone7 = %f", RedTeamCarrier08PhiAtMilestone7);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 140 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier08PhiAtMilestone8;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier08XPositionAtMilestone8;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier08ZPositionAtMilestone8;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier08PhiAtMilestone8;
        sprintf(DebugBuf, "MissionNetworkBattle08::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier08XPositionAtMilestone8 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier08ZPositionAtMilestone8 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier08PhiAtMilestone8 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08XPositionAtMilestone8 = %f", RedTeamCarrier08XPositionAtMilestone8);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08ZPositionAtMilestone8 = %f", RedTeamCarrier08ZPositionAtMilestone8);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08PhiAtMilestone8 = %f", RedTeamCarrier08PhiAtMilestone8);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
        ...
        sprintf(DebugBuf, "MissionNetworkBattle08::processtimer(): MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
    }
    ...
    if (MissionStateNetworkBattle == 160 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier08PhiAtMilestone9;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier08XPositionAtMilestone9;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier08ZPositionAtMilestone9;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier08PhiAtMilestone9;
        sprintf(DebugBuf, "MissionNetworkBattle08::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier08XPositionAtMilestone9 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier08ZPositionAtMilestone9 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier08PhiAtMilestone9 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08XPositionAtMilestone9 = %f", RedTeamCarrier08XPositionAtMilestone9);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08ZPositionAtMilestone9 = %f", RedTeamCarrier08ZPositionAtMilestone9);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08PhiAtMilestone9 = %f", RedTeamCarrier08PhiAtMilestone9);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 180 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier08PhiAtMilestone10;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier08XPositionAtMilestone10;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier08ZPositionAtMilestone10;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier08PhiAtMilestone10;
        sprintf(DebugBuf, "MissionNetworkBattle08::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier08XPositionAtMilestone10 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier08ZPositionAtMilestone10 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier08PhiAtMilestone10 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08XPositionAtMilestone10 = %f", RedTeamCarrier08XPositionAtMilestone10);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08ZPositionAtMilestone10 = %f", RedTeamCarrier08ZPositionAtMilestone10);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer() RedTeamCarrier08PhiAtMilestone10 = %f", RedTeamCarrier08PhiAtMilestone10);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle08::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    for (MissionAircraftNumber = 1; MissionAircraftNumber <= 10; MissionAircraftNumber++) {
        ...
        if (ThreeDObjects[0]->explode > 500 * timestep) {
            ...
            display((char*)"MissionNetworkBattle08::processtimer(): Player plane is dead and player has waited for program to exit. Invoking game_quit().", LOG_MOST);
        ...
        if (!ThreeDObjects[MissionAircraftNumber]->active && (myrandom(10000) > 9990)) { //  Get here 0.5% of the time after any other plane explodes or crashes. Re-spawn destroyed aircraft.
            ...
            //
            sprintf(DebugBuf, "MissionNetworkBattle08::ProcessTimer() re-spawning aircraft #%d.", MissionAircraftNumber);
            display(DebugBuf, LOG_MOST);
            //
            ...
            if (ThreeDObjects[MissionAircraftNumber]->Sentient > 3) {//  Get here if the destroyed aircraft was piloted by a Sentient. Some extra steps are needed.
                ...
                MissionNetworkBattle08PriorAircraft[MissionAircraftNumber] = ThreeDObjects[MissionAircraftNumber]->id;
         ...
         //
            ...
            sprintf(
                DebugBuf,
                "MissionNetworkBattle08::processTimer() spawning new aircraft %d at X=%f Y=%f Z=%f",
...
// Check to see if the player's aircraft has been destroyed:
    ...
    if (MissionNetworkBattleRadarTimer > 100) { //  Get here 10 times /second.
        ...
        if (ThreeDObjects[MissionObjectCarrierRed1]->active) { //@ Get here if this aircraft carrier has not been destroyed. It can still move.
            ThreeDObjects[MissionObjectCarrierRed1]->phi += MissionObjectCarrierRed1RudderDegreesM08;
        ...
        if (ThreeDObjects[MissionObjectCarrierRed1]->active) { //@ Get here if this aircraft carrier has not been destroyed. It can still move.
            ThreeDObjects[MissionObjectCarrierBlue1]->phi += MissionObjectCarrierBlue1RudderDegreesM08;
        ...
        if (ThreeDObjects[MissionObjectCarrierRed1]->active) { //@ Get here if this aircraft carrier has not been destroyed. It can still move.
            ThreeDObjects[MissionObjectCarrierRed1]->tl->x -=
                (
                    MissionObjectCarrierRed1ThrustM08 * cos(((ThreeDObjects[MissionObjectCarrierRed1]->phi) + 0) * DegreesToRadiansFactor)
                    );
            ThreeDObjects[MissionObjectCarrierRed1]->tl->z -=
                (
                    MissionObjectCarrierRed1ThrustM08 * sin(((ThreeDObjects[MissionObjectCarrierRed1]->phi) + 0) * DegreesToRadiansFactor)
                    );
        }
        //
        ...
        if (ThreeDObjects[MissionObjectCarrierBlue1]->active) { //@ Get here if this aircraft carrier has not been destroyed. It can still move.
            ThreeDObjects[MissionObjectCarrierBlue1]->tl->x -=
                (
                    MissionObjectCarrierBlue1ThrustM08 * cos(((ThreeDObjects[MissionObjectCarrierBlue1]->phi) + 0) * DegreesToRadiansFactor)
                    );
            ThreeDObjects[MissionObjectCarrierBlue1]->tl->z -=
                (
                    MissionObjectCarrierBlue1ThrustM08 * sin(((ThreeDObjects[MissionObjectCarrierBlue1]->phi) + 0) * DegreesToRadiansFactor)
                    );
        }
        //
        ...
        if (MissionChronoMilestone != PriorChronoMilestone) { // Get here within 100 milliseconds of receipt of a new Chrono Milestone message
            sprintf(DebugBuf, "MissionNetworkBattle08(): Detected change in MissionChronoMilestone. Now %d.", MissionChronoMilestone);
            display(DebugBuf, LOG_MOST);
    ...
    if (MissionNetworkBattle08Timer > 1000) { //  Get here once every second.
        MissionNetworkBattle08Timer = 0;
        //
        ...
        NewSystemMessageNeedsScrolling = true;
    } //  end of (MissionNetworkBattle08Timer > 1000)
    ...
    if ((BattleDamageRiskTimer > 5000) || (BattleDamageRiskTimer > (abs)(myrandom(131072)))) { //  Get here at least every 5 seconds, or possibly sooner by random chance
        ...
        if (CalculatedDamageDueToCurrentRisk > 0) { //  Get here once every time we suffer new damage. Log it...
            sprintf(DebugBuf, "MissionNetworkBattle08::processTimer() fplayer->Durability is now %f.", fplayer->Durability);
            display(DebugBuf, LOG_MOST);
    ...
    if (StaticObjectUpdateTimer > 2000) { //  Get here when it's time to update network peers regarding any damaged airfields, etc.
        ...
        if (StaticUpdateSwitcher == 1) { //  Get here if it's time to handle MissionObjectHqBlue
            ...
            if (ThreeDObjects[MissionObjectAirfieldBlue2]->active) { // Get here if this object has NOT been destroyed. Issue Static update of its status.
                ...
                display((char*)"MissionNetworkBattle08::processTimer(): MissionObjectAirfieldBlue2 destroyed. Setting DamageInNetQueue = -0.01.", LOG_MOST);
            }
            ...
            if (ThreeDObjects[MissionObjectAirfieldRed2]->active) { // Get here if this object has NOT been destroyed. Issue Static update of its status.
                ...
                display((char*)"MissionNetworkBattle08::processTimer(): MissionObjectAirfieldRed2 destroyed. Setting DamageInNetQueue = -0.01.", LOG_MOST);
            }
            ...
            if (ThreeDObjects[MissionObjectCarrierBlue1]->active) { // Get here if this object has NOT been destroyed. Issue Static update of its status.
                ...
                display((char*)"MissionNetworkBattle08::processTimer(): MissionObjectCarrierBlue1 destroyed. Setting DamageInNetQueue = -0.01.", LOG_MOST);
            }
            ...
            if (ThreeDObjects[MissionObjectCarrierRed1]->active) { // Get here if this object has NOT been destroyed. Issue Static update of its status.
                ...
                display((char*)"MissionNetworkBattle08::processTimer(): MissionObjectCarrierRed1 destroyed. Setting DamageInNetQueue = -0.01.", LOG_MOST);
            }
        }
    ...
    if (NetworkReceiveTimer > NetworkReceiveTimerInterval) { //  Get here every time NetworkReceiveTimer expires. Check for new InPacket:
        ...
        if (BytesReceived == sizeof(LacUdpApiPacket)) { //  Get here if a new InPacket has arrived.
            ...
            display((char*)"MissionNetworkBattle08 BytesReceived=", LOG_NET);
            ...
            if (MissionNetworkBattle08PriorAircraft[InPacket.UdpObjPlayerNumber] != InPacket.UdpObjVehicle) { //  Get here if this network peer is in a different type of aircraft
                //
            ...
            MissionNetworkBattle08PriorAircraft[InPacket.UdpObjPlayerNumber] = InPacket.UdpObjVehicle;
 ...
 //
    ...
    if (NetworkTransmitTimer > NetworkTransmitTimerInterval && !NetworkPlayerKilled) { //  Get here if we're alive and it's time to send a new network API packet.
        ...
        MissionNetworkBattle08RetrieveFirstDamageDescription();
    ...
    if (BlueTeamHasWonTheBattle || RedTeamHasWonTheBattle) { //  Get here if one of the two teams has destroyed BOTH of its opposing airfields and carrier.
        ...
        if (MissionEndingTimer < -200 && CountdownLatch1 == false) { //  Get here 5 seconds after either team wins the battle.
            display((char*)"MissionNetworkBattle08::processtimer() Playing audio file MissionEndingInstrumental.wav", LOG_MOST);
    ...
    if (MissionEndingTimer2) { //  Get here many times, but only after the "countdown warning audio" has begun playing.
        ...
        if (MissionEndingTimer2 < 1000) { //  Get here 16 seconds after "Countdown warning audio" started.
            ...
            display((char*)"MissionNetworkBattle08::processtimer(): Mission ending now.", LOG_MOST);
            fplayer->Durability = -1.0; //  Signal Destruction of player and end the mission.
        }
    }
    return 0;
} //  end MissionNetworkBattle08::processtimer (Uint32 dt)
...
//  here.
//
void MissionNetworkBattle08::draw() {
    if (timer >= 0 && timer <= 50 * timestep) {
        font1->drawTextCentered(0, 12, -2, name, &textcolor);
    }
} //  end MissionNetworkBattle08::draw ()
...
bool MissionNetworkBattle08RetrieveFirstDamageDescription() {
    int Mission3dObject;
    display((char*)"MissionNetworkBattle08RetrieveFirstDamageDescription()", LOG_NET);
    ...
    DamageToClaim = 0.0;
    return (false);
} //  end MissionNetworkBattle08RetrieveFirstDamageDescription()
