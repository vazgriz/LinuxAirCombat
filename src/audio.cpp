...
void WaveFile::load(const std::string& fn) {
    const char* filename = fn.c_str();
    display("WaveFile::load (char *filename)", LOG_MOST);
...
SoundSystem::SoundSystem() {
    ...
    volumemusic = 100;
    char buf[STDSIZE];
    display("SoundSystem::SoundSystem() Using SDL_mixer", LOG_MOST);
    ...
    music1 = Mix_LoadMUS(dirs->getMusic("Music00.wav").c_str());
    if (music1 == NULL) {
    ...
    wavebomb01 = new WaveFile(dirs->getSounds("bomb01.wav"));
    waveWindNoise = new WaveFile(dirs->getSounds("WindNoise.wav"));
    for (i = 0; i < 2; i++) {
    ...
    waveflapsdn = new WaveFile(dirs->getSounds("flapsdn.wav"));
    waveflapsdn->setVolume(80);
    waveflapsup = new WaveFile(dirs->getSounds("flapsup.wav"));
    waveflapsup->setVolume(80);
    wavespeedbrake = new WaveFile(dirs->getSounds("speedbrake.wav"));
    wavespeedbrake->setVolume(80);
    wavespeedbrake1 = new WaveFile(dirs->getSounds("speedbrake1.wav"));
    wavespeedbrake1->setVolume(80);
    wavetiresqueak1 = new WaveFile(dirs->getSounds("TireSqueak00.wav"));
    wavetiresqueak1->setVolume(80);
    wavedamage00 = new WaveFile(dirs->getSounds("Damage00.wav"));
    wavedamage00->setVolume(80);
    wavecrashocean00 = new WaveFile(dirs->getSounds("CrashOcean00.wav"));
    wavecrashocean00->setVolume(80);
    wavebellyscrape00 = new WaveFile(dirs->getSounds("BellyScrape00.wav"));
    wavebellyscrape00->setVolume(80);
    wavewheelrollout00 = new WaveFile(dirs->getSounds("WheelRollout00.wav"));
    wavewheelrollout00->setVolume(80);
    wavedigit000 = new WaveFile(dirs->getSounds("000.wav"));
    wavedigit000->setVolume(80);
    wavedigit001 = new WaveFile(dirs->getSounds("001.wav"));
    wavedigit001->setVolume(80);
    wavedigit002 = new WaveFile(dirs->getSounds("002.wav"));
    wavedigit002->setVolume(80);
    wavedigit003 = new WaveFile(dirs->getSounds("003.wav"));
    wavedigit003->setVolume(80);
    wavedigit004 = new WaveFile(dirs->getSounds("004.wav"));
    wavedigit004->setVolume(80);
    wavedigit005 = new WaveFile(dirs->getSounds("005.wav"));
    wavedigit005->setVolume(80);
    wavedigit006 = new WaveFile(dirs->getSounds("006.wav"));
    wavedigit006->setVolume(80);
    wavedigit007 = new WaveFile(dirs->getSounds("007.wav"));
    wavedigit007->setVolume(80);
    wavedigit008 = new WaveFile(dirs->getSounds("008.wav"));
    wavedigit008->setVolume(80);
    wavedigit009 = new WaveFile(dirs->getSounds("009.wav"));
    wavedigit009->setVolume(80);
    wavedigit010 = new WaveFile(dirs->getSounds("010.wav"));
    wavedigit010->setVolume(80);
    wavedigit011 = new WaveFile(dirs->getSounds("011.wav"));
    wavedigit011->setVolume(80);
    wavedigit012 = new WaveFile(dirs->getSounds("012.wav"));
    wavedigit012->setVolume(80);
    wavedigit013 = new WaveFile(dirs->getSounds("013.wav"));
    wavedigit013->setVolume(80);
    wavedigit014 = new WaveFile(dirs->getSounds("014.wav"));
    wavedigit014->setVolume(80);
    wavedigit015 = new WaveFile(dirs->getSounds("015.wav"));
    wavedigit015->setVolume(80);
    wavedigit016 = new WaveFile(dirs->getSounds("016.wav"));
    wavedigit016->setVolume(80);
    wavedigit017 = new WaveFile(dirs->getSounds("017.wav"));
    wavedigit017->setVolume(80);
    wavedigit018 = new WaveFile(dirs->getSounds("018.wav"));
    wavedigit018->setVolume(80);
    wavedigit019 = new WaveFile(dirs->getSounds("019.wav"));
    wavedigit019->setVolume(80);
    wavedigit020 = new WaveFile(dirs->getSounds("020.wav"));
    wavedigit020->setVolume(80);
    wavedigit030 = new WaveFile(dirs->getSounds("030.wav"));
    wavedigit030->setVolume(80);
    waveBlue = new WaveFile(dirs->getSounds("Blue.wav"));
    waveBlue->setVolume(80);
    waveBoseNetDotNoDashIpDotBiz = new WaveFile(dirs->getSounds("BoseNetDotNoDashIpDotBiz.wav"));
    waveBoseNetDotNoDashIpDotBiz->setVolume(80);
    waveChannel = new WaveFile(dirs->getSounds("Channel.wav"));
    waveChannel->setVolume(80);
    waveGlobalAssignmentAudioAtMumble = new WaveFile(dirs->getSounds("GlobalAssignmentAudioAtMumble.wav"));
    waveGlobalAssignmentAudioAtMumble->setVolume(80);
    waveLinuxAirCombat = new WaveFile(dirs->getSounds("LinuxAirCombat.wav"));
    waveLinuxAirCombat->setVolume(80);
    waveMissionCommsOnChannel = new WaveFile(dirs->getSounds("MissionCommsOnChannel.wav"));
    waveMissionCommsOnChannel->setVolume(80);
    waveMissionNetworkBattle01 = new WaveFile(dirs->getSounds("MissionNetworkBattle01.wav"));
    waveMissionNetworkBattle01->setVolume(80);
    waveMissionNetworkBattle02 = new WaveFile(dirs->getSounds("MissionNetworkBattle02.wav"));
    waveMissionNetworkBattle02->setVolume(80);
    waveMissionNetworkBattle03 = new WaveFile(dirs->getSounds("MissionNetworkBattle03.wav"));
    waveMissionNetworkBattle03->setVolume(80);
    waveMissionTelemetryAvailableFromLacServerAt = new WaveFile(dirs->getSounds("MissionTelemetryAvailableFromLacServerAt.wav"));
    waveMissionTelemetryAvailableFromLacServerAt->setVolume(80);
    waveRed = new WaveFile(dirs->getSounds("Red.wav"));
    waveRed->setVolume(80);
    waveSquadCommsOnSubchannel = new WaveFile(dirs->getSounds("SquadCommsOnSubchannel.wav"));
    waveSquadCommsOnSubchannel->setVolume(80);
    waveWeaponsFree = new WaveFile(dirs->getSounds("WeaponsFree.wav"));
    waveWeaponsFree->setVolume(80);
    waveYouHaveAuthorityToProceed = new WaveFile(dirs->getSounds("YouHaveAuthorityToProceed.wav"));
    waveYouHaveAuthorityToProceed->setVolume(80);
    waveundercarriage = new WaveFile(dirs->getSounds("undercarriage.wav"));
    waveundercarriage->setVolume(80);
    waveNewBanditOnRadar01 = new WaveFile(dirs->getSounds("NewBanditOnRadar01.wav"));
    waveNewBanditOnRadar01->setVolume(80);
    waveRadarBanditDisappeared01 = new WaveFile(dirs->getSounds("RadarBanditDisappeared01.wav"));
    waveRadarBanditDisappeared01->setVolume(80);
    waveTarget = new WaveFile(dirs->getSounds("Target.wav"));
    waveTarget->setVolume(80);
    waveIsAt = new WaveFile(dirs->getSounds("IsAt.wav"));
    waveIsAt->setVolume(80);
    waveAngels = new WaveFile(dirs->getSounds("Angels.wav"));
    waveAngels->setVolume(80);
    waveOclock = new WaveFile(dirs->getSounds("Oclock.wav"));
    waveOclock->setVolume(80);
    waveVoiceCommsZello1 = new WaveFile(dirs->getSounds("VoiceCommsMumble01.wav"));
    waveVoiceCommsZello1->setVolume(80);
    waveMissionEndingInstrumental = new WaveFile(dirs->getSounds("MissionEndingInstrumental.wav"));
    waveMissionEndingInstrumental->setVolume(127);
    waveBlueTeamHasWonBattle = new WaveFile(dirs->getSounds("BlueTeamHasWonBattle.wav"));
    waveBlueTeamHasWonBattle->setVolume(127);
    waveRedTeamHasWonBattle = new WaveFile(dirs->getSounds("RedTeamHasWonBattle.wav"));
    waveRedTeamHasWonBattle->setVolume(127);
    waveMissionEndingIn15SecCountdown = new WaveFile(dirs->getSounds("MissionEndingIn15SecCountdown.wav"));
    waveMissionEndingIn15SecCountdown->setVolume(127);
    waveEnemyHqStatus100a = new WaveFile(dirs->getSounds("EnemyHqAirfieldStatus100Percent.wav"));
    waveEnemyHqStatus100a->setVolume(127);
    LacStartup00 = new WaveFile(dirs->getSounds("Startup00.wav"));
    LacStartup00->setVolume(127);
    EnemyHqAckAckFrom01to10Pct = new WaveFile(dirs->getSounds("EnemyHqAckAckFrom01to10Pct.wav"));
    EnemyHqAckAckFrom01to10Pct->setVolume(127);
    EnemyHqAckAckFrom10to20Pct = new WaveFile(dirs->getSounds("EnemyHqAckAckFrom10to20Pct.wav"));
    EnemyHqAckAckFrom10to20Pct->setVolume(127);
    EnemyHqAckAckFrom20to30Pct = new WaveFile(dirs->getSounds("EnemyHqAckAckFrom20to30Pct.wav"));
    EnemyHqAckAckFrom20to30Pct->setVolume(127);
    EnemyHqAckAckFrom30to40Pct = new WaveFile(dirs->getSounds("EnemyHqAckAckFrom30to40Pct.wav"));
    EnemyHqAckAckFrom30to40Pct->setVolume(127);
    EnemyHqAckAckFrom40to50Pct = new WaveFile(dirs->getSounds("EnemyHqAckAckFrom40to50Pct.wav"));
    EnemyHqAckAckFrom40to50Pct->setVolume(127);
    EnemyHqAckAckFrom50to60Pct = new WaveFile(dirs->getSounds("EnemyHqAckAckFrom50to60Pct.wav"));
    EnemyHqAckAckFrom50to60Pct->setVolume(127);
    EnemyHqAckAckFrom60to70Pct = new WaveFile(dirs->getSounds("EnemyHqAckAckFrom60to70Pct.wav"));
    EnemyHqAckAckFrom60to70Pct->setVolume(127);
    EnemyHqAckAckFrom70to80Pct = new WaveFile(dirs->getSounds("EnemyHqAckAckFrom70to80Pct.wav"));
    EnemyHqAckAckFrom70to80Pct->setVolume(127);
    EnemyHqAckAckFrom80to90Pct = new WaveFile(dirs->getSounds("EnemyHqAckAckFrom80to90Pct.wav"));
    EnemyHqAckAckFrom80to90Pct->setVolume(127);
    EnemyHqAckAckFrom90to100Pct = new WaveFile(dirs->getSounds("EnemyHqAckAckFrom90to100Pct.wav"));
    EnemyHqAckAckFrom90to100Pct->setVolume(127);
    EnemyHqRepairsProceedingNormally = new WaveFile(dirs->getSounds("EnemyHqRepairsProceedingNormally.wav"));
    EnemyHqRepairsProceedingNormally->setVolume(127);
    EnemyHqRepairsProceedingRapidly = new WaveFile(dirs->getSounds("EnemyHqRepairsProceedingRapidly.wav"));
    EnemyHqRepairsProceedingRapidly->setVolume(127);
    EnemyHqRepairsStopped = new WaveFile(dirs->getSounds("EnemyHqRepairsStopped.wav"));
    EnemyHqRepairsStopped->setVolume(127);
    Morse0000 = new WaveFile(dirs->getSounds("Morse0000.wav"));
    Morse0000->setVolume(127);
    Morse0100 = new WaveFile(dirs->getSounds("Morse0100.wav"));
    Morse0100->setVolume(127);
    Morse0200 = new WaveFile(dirs->getSounds("Morse0200.wav"));
    Morse0200->setVolume(127);
    Morse0300 = new WaveFile(dirs->getSounds("Morse0300.wav"));
    Morse0300->setVolume(127);
    Morse0400 = new WaveFile(dirs->getSounds("Morse0400.wav"));
    Morse0400->setVolume(127);
    Morse0500 = new WaveFile(dirs->getSounds("Morse0500.wav"));
    Morse0500->setVolume(127);
    Morse0600 = new WaveFile(dirs->getSounds("Morse0600.wav"));
    Morse0600->setVolume(127);
    Morse0700 = new WaveFile(dirs->getSounds("Morse0700.wav"));
    Morse0700->setVolume(127);
    Morse0800 = new WaveFile(dirs->getSounds("Morse0800.wav"));
    Morse0800->setVolume(127);
    Morse0900 = new WaveFile(dirs->getSounds("Morse0900.wav"));
    Morse0900->setVolume(127);
    MorseA00 = new WaveFile(dirs->getSounds("MorseA00.wav"));
    MorseA00->setVolume(127);
    MorseB00 = new WaveFile(dirs->getSounds("MorseB00.wav"));
    MorseB00->setVolume(127);
    MorseC00 = new WaveFile(dirs->getSounds("MorseC00.wav"));
    MorseC00->setVolume(127);
    MorseD00 = new WaveFile(dirs->getSounds("MorseD00.wav"));
    MorseD00->setVolume(127);
    MorseE00 = new WaveFile(dirs->getSounds("MorseE00.wav"));
    MorseE00->setVolume(127);
    MorseF00 = new WaveFile(dirs->getSounds("MorseF00.wav"));
    MorseF00->setVolume(127);
    MorseG00 = new WaveFile(dirs->getSounds("MorseG00.wav"));
    MorseG00->setVolume(127);
    MorseH00 = new WaveFile(dirs->getSounds("MorseH00.wav"));
    MorseH00->setVolume(127);
    MorseI00 = new WaveFile(dirs->getSounds("MorseI00.wav"));
    MorseI00->setVolume(127);
    MorseJ00 = new WaveFile(dirs->getSounds("MorseJ00.wav"));
    MorseJ00->setVolume(127);
    MorseK00 = new WaveFile(dirs->getSounds("MorseK00.wav"));
    MorseK00->setVolume(127);
    MorseL00 = new WaveFile(dirs->getSounds("MorseL00.wav"));
    MorseL00->setVolume(127);
    MorseM00 = new WaveFile(dirs->getSounds("MorseM00.wav"));
    MorseM00->setVolume(127);
    MorseN00 = new WaveFile(dirs->getSounds("MorseN00.wav"));
    MorseN00->setVolume(127);
    MorseO00 = new WaveFile(dirs->getSounds("MorseO00.wav"));
    MorseO00->setVolume(127);
    MorseP00 = new WaveFile(dirs->getSounds("MorseP00.wav"));
    MorseP00->setVolume(127);
    MorseQ00 = new WaveFile(dirs->getSounds("MorseQ00.wav"));
    MorseQ00->setVolume(127);
    MorseR00 = new WaveFile(dirs->getSounds("MorseR00.wav"));
    MorseR00->setVolume(127);
    MorseS00 = new WaveFile(dirs->getSounds("MorseS00.wav"));
    MorseS00->setVolume(127);
    MorseT00 = new WaveFile(dirs->getSounds("MorseT00.wav"));
    MorseT00->setVolume(127);
    MorseU00 = new WaveFile(dirs->getSounds("MorseU00.wav"));
    MorseU00->setVolume(127);
    MorseV00 = new WaveFile(dirs->getSounds("MorseV00.wav"));
    MorseV00->setVolume(127);
    MorseW00 = new WaveFile(dirs->getSounds("MorseW00.wav"));
    MorseW00->setVolume(127);
    MorseX00 = new WaveFile(dirs->getSounds("MorseX00.wav"));
    MorseX00->setVolume(127);
    MorseY00 = new WaveFile(dirs->getSounds("MorseY00.wav"));
    MorseY00->setVolume(127);
    MorseZ00 = new WaveFile(dirs->getSounds("MorseZ00.wav"));
    ...
    XMorseSlash00 = new WaveFile(dirs->getSounds("XMorseSlash.wav"));
    XMorseSlash00->setVolume(127);
    AirRaidSiren = new WaveFile(dirs->getSounds("AirRaidSiren.wav"));
    AirRaidSiren->setVolume(127);
    Defeat00 = new WaveFile(dirs->getSounds("Defeat00.wav"));
    Defeat00->setVolume(127);
    FiveBeeps00 = new WaveFile(dirs->getSounds("FiveLoudBeeps.wav"));
...
void SoundSystem::play(int sample, bool loop) {
    ...
    case SOUND_MISSIONENDINGIN15SECCOUNTDOWN:
        waveMissionEndingIn15SecCountdown->play(0, loop);
        break;
    ...
    case SOUND_MISSIONENDINGINSTRUMENTAL:
        waveMissionEndingInstrumental->play(0, loop); //@ was 2
        break;
...
void SoundSystem::loadMusic(int sample) {
    ...
    case MUSIC_ANDCOMBAT:
        music1 = Mix_LoadMUS(dirs->getMusic("MusicAndCombat00.wav").c_str());
        break;
    case MUSIC_TUTORIAL01:
        display("SoundSystem::loadMusic() loading MUSIC_TUTORIAL01", LOG_MOST);
        music1 = Mix_LoadMUS(dirs->getMusic("MusicTutorial1.wav").c_str());
        break;
    case MUSIC_TUTORIAL02:
        display("SoundSystem::loadMusic() loading MUSIC_TUTORIAL02", LOG_MOST);
        music1 = Mix_LoadMUS(dirs->getMusic("MusicTutorial2.wav").c_str());
        break;
    case MUSIC_TUTORIAL03:
        display("SoundSystem::loadMusic() loading MUSIC_TUTORIAL03", LOG_MOST);
        music1 = Mix_LoadMUS(dirs->getMusic("MusicTutorial3.wav").c_str());
        break;
    case MUSIC_MISSIONNETWORKBATTLE01:
        display("SoundSystem::loadMusic() loading MUSIC_MISSIONNETWORKBATTLE01", LOG_MOST);
        music1 = Mix_LoadMUS(dirs->getMusic("MusicMissionNetworkBattle01.wav").c_str());
        break;
    case MUSIC_MISSIONNETWORKBATTLE02:
        display("SoundSystem::loadMusic() loading MUSIC_MISSIONNETWORKBATTLE02", LOG_MOST);
        music1 = Mix_LoadMUS(dirs->getMusic("MusicMissionNetworkBattle02.wav").c_str());
        break;
    case MUSIC_MISSIONNETWORKBATTLE03:
        display("SoundSystem::loadMusic() loading MUSIC_MISSIONNETWORKBATTLE03", LOG_MOST);
        music1 = Mix_LoadMUS(dirs->getMusic("MusicMissionNetworkBattle03.wav").c_str());
        break;
    case MUSIC_HEADTOHEAD:
        display("SoundSystem::loadMusic() loading MUSIC_HEADTOHEAD", LOG_MOST);
        music1 = Mix_LoadMUS(dirs->getMusic("MusicHeadToHead00.wav").c_str());
        break;
    case MUSIC_MUSIC01:
        music1 = Mix_LoadMUS(dirs->getMusic("Music00.wav").c_str());
        break;
    case MUSIC_MUSIC02:
        music1 = Mix_LoadMUS(dirs->getMusic("Music01.wav").c_str());
        break;
    case MUSIC_MUSIC03:
        music1 = Mix_LoadMUS(dirs->getMusic("Music02.wav").c_str());
        break;
    case MUSIC_MUSIC02ANDFURBALLAA:
        music1 = Mix_LoadMUS(dirs->getMusic("Music02AndFurballAA.wav").c_str());
        break;
    }
