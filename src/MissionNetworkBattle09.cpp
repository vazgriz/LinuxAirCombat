...
//
//  This file implements "MissionNetworkBattle09".
//
...
//
float RedTeamCarrier09XPositionAtMilestone1 = 272.105042;
float RedTeamCarrier09ZPositionAtMilestone1 = -76.429771;
float RedTeamCarrier09PhiAtMilestone1 = 246.202545;
float RedTeamCarrier09XPositionAtMilestone2 = 260.318420;
float RedTeamCarrier09ZPositionAtMilestone2 = -136.597427;
float RedTeamCarrier09PhiAtMilestone2 = 315.804138;
float RedTeamCarrier09XPositionAtMilestone3 = 266.714844;
float RedTeamCarrier09ZPositionAtMilestone3 = -66.925232;
float RedTeamCarrier09PhiAtMilestone3 = 234.528992;
float RedTeamCarrier09XPositionAtMilestone4 = 198.952469;
float RedTeamCarrier09ZPositionAtMilestone4 = -49.964832;
float RedTeamCarrier09PhiAtMilestone4 = 153.413849;
float RedTeamCarrier09XPositionAtMilestone5 = 171.683975;
float RedTeamCarrier09ZPositionAtMilestone5 = -114.148750;
float RedTeamCarrier09PhiAtMilestone5 = 72.458717;
float RedTeamCarrier09XPositionAtMilestone6 = 231.078461;
float RedTeamCarrier09ZPositionAtMilestone6 = -151.122269;
float RedTeamCarrier09PhiAtMilestone6 = 351.185089;
float RedTeamCarrier09XPositionAtMilestone7 = 276.633148;
float RedTeamCarrier09ZPositionAtMilestone7 = -98.321991;
float RedTeamCarrier09PhiAtMilestone7 = 270.229950;
float RedTeamCarrier09XPositionAtMilestone8 = 230.909607;
float RedTeamCarrier09ZPositionAtMilestone8 = -44.914185;
float RedTeamCarrier09PhiAtMilestone8 = 188.474792;
float RedTeamCarrier09XPositionAtMilestone9 = 171.672470;
float RedTeamCarrier09ZPositionAtMilestone9 = -81.931099;
float RedTeamCarrier09PhiAtMilestone9 = 107.359657;
float RedTeamCarrier09XPositionAtMilestone10 = 198.961212;
float RedTeamCarrier09ZPositionAtMilestone10 = -146.105331;
float RedTeamCarrier09PhiAtMilestone10 = 26.405413;

float BlueTeamCarrier09XPositionAtMilestone1 = -239.394958;
float BlueTeamCarrier09ZPositionAtMilestone1 = -76.429771;
float BlueTeamCarrier09PhiAtMilestone1 = 246.202545;
float BlueTeamCarrier09XPositionAtMilestone2 = -251.181580;
float BlueTeamCarrier09ZPositionAtMilestone2 = -136.597427;
float BlueTeamCarrier09PhiAtMilestone2 = 315.804138;
float BlueTeamCarrier09XPositionAtMilestone3 = -244.785156;
float BlueTeamCarrier09ZPositionAtMilestone3 = -66.925232;
float BlueTeamCarrier09PhiAtMilestone3 = 234.528992;
float BlueTeamCarrier09XPositionAtMilestone4 = -312.547516;
float BlueTeamCarrier09ZPositionAtMilestone4 = -49.964832;
float BlueTeamCarrier09PhiAtMilestone4 = 153.413849;
float BlueTeamCarrier09XPositionAtMilestone5 = -339.816040;
float BlueTeamCarrier09ZPositionAtMilestone5 = -114.148750;
float BlueTeamCarrier09PhiAtMilestone5 = 72.458717;
float BlueTeamCarrier09XPositionAtMilestone6 = -280.421539;
float BlueTeamCarrier09ZPositionAtMilestone6 = -151.122269;
float BlueTeamCarrier09PhiAtMilestone6 = 351.185089;
float BlueTeamCarrier09XPositionAtMilestone7 = -234.866852;
float BlueTeamCarrier09ZPositionAtMilestone7 = -98.321991;
float BlueTeamCarrier09PhiAtMilestone7 = 270.229950;
float BlueTeamCarrier09XPositionAtMilestone8 = -280.590393;
float BlueTeamCarrier09ZPositionAtMilestone8 = -44.914185;
float BlueTeamCarrier09PhiAtMilestone8 = 188.474792;
float BlueTeamCarrier09XPositionAtMilestone9 = -339.827545;
float BlueTeamCarrier09ZPositionAtMilestone9 = -81.931099;
float BlueTeamCarrier09PhiAtMilestone9 = 107.359657;
float BlueTeamCarrier09XPositionAtMilestone10 = -312.538788;
float BlueTeamCarrier09ZPositionAtMilestone10 = -146.105331;
float BlueTeamCarrier09PhiAtMilestone10 = 26.405413;

float MissionObjectCarrierBlue1RudderDegreesM09 = 0.16;
float MissionObjectCarrierBlue1ThrustM09 = 0.15;
float MissionObjectCarrierRed1RudderDegreesM09 = 0.16;
float MissionObjectCarrierRed1ThrustM09 = 0.15;

//
// Mission-specific code commences here:
//
MissionNetworkBattle09::MissionNetworkBattle09() {
    //
    ...
    //
    display((char*)"MissionNetworkBattle09::MissionNetworkBattle09()", LOG_MOST);
    id = MISSION_NETWORKBATTLE09;
    if ((NetworkMode & 1) == 0) {
        strncpy(name, "WRONG NETWORK MODE!", 1024);
        strncpy(briefing, "LACCONFIG.TXT FILE MUST SET MODE 1, 3, OR 5 AND A SERVER ADDRESS.", 1024);
    } else {
        strncpy(name, "NETWORK MISSION 09 (BETA TEST)", 1024);
    ...
    if ((NetworkMode & 1) == 1) { //  ClientServer mode requires only a single UDP port, used both for sending and receiving
        display((char*)"Attempting MissionNetworkBattle09 in ClientServer Network mode.", LOG_NET);
        if (OpenClientUdpSocket() == 0) { //  Get here if we were able to open the required ClientServer UDP Socket
            display((char*)"MissionNetworkBattle09 ClientServer mode succesfully opened ClientUDP socket", LOG_NET);
            ConfigureClientUdpSocket();
        } else { //  Get here if we were unable to open the required ClientUDP socket
            display((char*)"MissionNetworkBattle09 ClientServer mode unable to open ClientUDP socket.", LOG_NET);
        }
    } else {
    ...
    //
    event_CommsMacro17();
} //  end MissionNetworkBattle09::MissionNetworkBattle09 ()

void MissionNetworkBattle09::start() {
    ...
    //
    if (!(NetworkMode & 16)) {
        popen("espeak -p 10 -a 66  -s 160 \"Welcome to Net Mission 09! This is an experimental, new mission, still under development. At present it is bigger and more sophisticated than any of our three classic multi-player missions. Victory requires destruction of two opposing airfields.\"", "r");
    }
    MissionStateNetworkBattle = 0;
    display((char*)"MissionNetworkBattle09::start()", LOG_MOST);
    ...
    //
    display((char*)"MissionNetworkBattle09::start setting PlayerAircraftType to: ", LOG_MOST);
    ...
    for (i = 1; i <= 10; i++) {
        ...
        MissionNetworkBattle09PriorAircraft[i] = FIGHTER_F4F;
        //
        ...
        //
        sprintf(DebugBuf, "MissionNetworkBattle09::start() initializing Bot #%d", i);
        display(DebugBuf, LOG_MOST);
        sprintf(
            DebugBuf,
            "MissionNetworkBattle09::start() ThreeDObjects [i]->MyMissionPlayerNumber = %d",
...
} //  end MissionNetworkBattle09::start ()

int MissionNetworkBattle09::processtimer(Uint32 dt) {
    ...
    //  this mission:
    //
    MissionNetworkBattle09Timer += DeltaTime; //  Advance by milliseconds
    ...
    if (!MissionRunning) { //  Get here if this is the FIRST pass through processtimer().
        ...
        */
        ...
        if (fplayer->missiles[0] >= 4 || fplayer->id == FIGHTER_D3A || fplayer->id == BOMBER_B5N) { //  Heavy bombers need more initial altitude and distance to avoid stalling and crashing...
            fplayer->tl->y += 60;
            sprintf(DebugBuf, "MissionNetworkBattle09::processtimer() Heavy bomber launching. AirfieldRequested = %d", AirfieldRequested);
            display(DebugBuf, LOG_MOST);
            if (AirfieldRequested >= 3) { //  Get here if launching from the most remote airfield (in a heavy bomber).
                display((char*)"MissionNetworkBattle09::processtimer() Increasing heavy bomber spawn altitude from Field 4", LOG_MOST);
 ...
 //
    ...
    if (timer > 10000 && MissionStateNetworkBattle == 0 && NetworkTransmitTimer >= NetworkTransmitTimerInterval) { //  Only get here once, 10 seconds into the mission, as we've just begun transmitting OutPackets
        ...
        MissionObjectCarrierRed1RudderDegreesM09 = 0.16;
        MissionObjectCarrierRed1ThrustM09 = 0.150;
    ...
    if (MissionStateNetworkBattle == 2 && (timer > PriorStateEndTimer + 1100)) { //  Only get here once, 1100 sec after MissionStateNetworkBattle
        ...
        //
        if (MyNetworkId % 2) { //  RedTeam MissionNetworkBattle09
            if (ThreeDObjects[MissionObjectHqRed]->Durability < ThreeDObjects[MissionObjectHqRed]->maxDurability * 0.4) { //  Get here if player's RedTeam HQ is heavily damaged. Diminish fuel/armament for late-war aircraft.
                display((char*)"MissionNetworkBattle09 state 2: Player's RedTeam HQ is heavily damaged.", LOG_MOST);
                if (fplayer->HistoricPeriod > 1) { //  Get here if the player is flying a late-war or postwar aircraft in this MissionNetworkBattle09
                    ...
                    for (i2 = 0; i2 < missiletypes; i2++) {
                        if (i2 == 0) { //  Rack0 = BOMB01
                            ...
                            display((char*)"MissionNetworkBattle09::processtimer() diminishing RedTeam late-war bomb load due to heavy HQ airfield damage", LOG_MOST);
                        }
                        if (i2 == 5) { //  Rack5 = DFM Rockets
                            fplayer->missiles[i2] /= 3;
                            display((char*)"MissionNetworkBattle09::processtimer() diminishing RedTeam late-war rocket load due to heavy HQ airfield damage", LOG_MOST);
                        }
                    }
                ...
                display((char*)"MissionNetworkBattle09 state 1: Player's RedTeam HQ is NOT heavily damaged.", LOG_MOST);
                sprintf(SystemMessageBufferA, "OUR HQ FACILITIES PERMIT FULL FUEL/ORDNANCE.");
                NewSystemMessageNeedsScrolling = true;
            }
        } else { //  BlueTeam MissionNetworkBattle09
            if (ThreeDObjects[MissionObjectHqBlue]->Durability < ThreeDObjects[MissionObjectHqBlue]->maxDurability * 0.4) { //  Get here if player's BlueTeam HQ is heavily damaged. Diminish fuel/armament for late-war aircraft.
                if (fplayer->HistoricPeriod > 1) { //  Get here if the player is flying a late-war or postwar aircraft in this MissionNetworkBattle09
                    ...
                    for (i2 = 0; i2 < missiletypes; i2++) {
                        if (i2 == 0) { //  Rack0 = BOMB01
                            fplayer->missiles[i2] /= 3;
                            display((char*)"MissionNetworkBattle09::processtimer() diminishing BlueTeam late-war bomb load due to heavy HQ airfield damage", LOG_MOST);
                        }
                        if (i2 == 5) { //  Rack5 = DFM Rockets
                            fplayer->missiles[i2] /= 3;
                            display((char*)"MissionNetworkBattle09::processtimer() diminishing BlueTeam late-war rocket load due to heavy HQ airfield damage", LOG_MOST);
                        }
                    }
                } else { //  Get here if flying an early-war aircraft.
                    sprintf(SystemMessageBufferA, "WE HAVE FUEL/ORDNANCE FOR THAT AIRCRAFT.");
    ...
    if (MissionStateNetworkBattle == 15 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier09XPositionAtMilestone1;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier09ZPositionAtMilestone1;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier09PhiAtMilestone1;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier09XPositionAtMilestone1;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier09ZPositionAtMilestone1;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier09PhiAtMilestone1;
        sprintf(DebugBuf, "MissionNetworkBattle09::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        MissionStateNetworkBattle = 16;
        sprintf(DebugBuf, "MissionNetworkBattle09::processtimer()aa: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * use:
        RedTeamCarrier09XPositionAtMilestone1 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier09ZPositionAtMilestone1 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier09PhiAtMilestone1 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09XPositionAtMilestone1 = %f", RedTeamCarrier09XPositionAtMilestone1);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09ZPositionAtMilestone1 = %f", RedTeamCarrier09ZPositionAtMilestone1);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09PhiAtMilestone1 = %f", RedTeamCarrier09PhiAtMilestone1);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
        // the mission advancing through this MissionState, we adjust "RudderDegrees"
        // and "Thrust" variables here:
    ...
    if (MissionStateNetworkBattle == 20 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier09XPositionAtMilestone2;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier09ZPositionAtMilestone2;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier09PhiAtMilestone2;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier09XPositionAtMilestone2;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier09ZPositionAtMilestone2;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier09PhiAtMilestone2;
        sprintf(DebugBuf, "MissionNetworkBattle09::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier09XPositionAtMilestone2 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier09ZPositionAtMilestone2 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier09PhiAtMilestone2 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09XPositionAtMilestone2 = %f", RedTeamCarrier09XPositionAtMilestone2);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09ZPositionAtMilestone2 = %f", RedTeamCarrier09ZPositionAtMilestone2);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09PhiAtMilestone2 = %f", RedTeamCarrier09PhiAtMilestone2);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 40 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier09XPositionAtMilestone3;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier09ZPositionAtMilestone3;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier09PhiAtMilestone3;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier09XPositionAtMilestone3;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier09ZPositionAtMilestone3;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier09PhiAtMilestone3;
        sprintf(DebugBuf, "MissionNetworkBattle09::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier09XPositionAtMilestone3 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier09ZPositionAtMilestone3 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier09PhiAtMilestone3 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09XPositionAtMilestone3 = %f", RedTeamCarrier09XPositionAtMilestone3);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09ZPositionAtMilestone3 = %f", RedTeamCarrier09ZPositionAtMilestone3);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09PhiAtMilestone3 = %f", RedTeamCarrier09PhiAtMilestone3);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 60 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier09XPositionAtMilestone4;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier09ZPositionAtMilestone4;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier09PhiAtMilestone4;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier09XPositionAtMilestone4;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier09ZPositionAtMilestone4;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier09PhiAtMilestone4;
        sprintf(DebugBuf, "MissionNetworkBattle09::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier09XPositionAtMilestone4 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier09ZPositionAtMilestone4 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier09PhiAtMilestone4 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09XPositionAtMilestone4 = %f", RedTeamCarrier09XPositionAtMilestone4);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09ZPositionAtMilestone4 = %f", RedTeamCarrier09ZPositionAtMilestone4);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09PhiAtMilestone4 = %f", RedTeamCarrier09PhiAtMilestone4);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 80 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier09XPositionAtMilestone5;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier09ZPositionAtMilestone5;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier09PhiAtMilestone5;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier09XPositionAtMilestone5;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier09ZPositionAtMilestone5;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier09PhiAtMilestone5;
        sprintf(DebugBuf, "MissionNetworkBattle09::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier09XPositionAtMilestone5 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier09ZPositionAtMilestone5 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier09PhiAtMilestone5 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09XPositionAtMilestone5 = %f", RedTeamCarrier09XPositionAtMilestone5);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09ZPositionAtMilestone5 = %f", RedTeamCarrier09ZPositionAtMilestone5);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09PhiAtMilestone5 = %f", RedTeamCarrier09PhiAtMilestone5);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 100 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier09XPositionAtMilestone6;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier09ZPositionAtMilestone6;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier09PhiAtMilestone6;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier09XPositionAtMilestone6;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier09ZPositionAtMilestone6;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier09PhiAtMilestone6;
        sprintf(DebugBuf, "MissionNetworkBattle09::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier09XPositionAtMilestone6 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier09ZPositionAtMilestone6 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier09PhiAtMilestone6 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09XPositionAtMilestone6 = %f", RedTeamCarrier09XPositionAtMilestone6);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09ZPositionAtMilestone6 = %f", RedTeamCarrier09ZPositionAtMilestone6);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09PhiAtMilestone6 = %f", RedTeamCarrier09PhiAtMilestone6);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 120 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier09XPositionAtMilestone7;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier09ZPositionAtMilestone7;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier09PhiAtMilestone7;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier09XPositionAtMilestone7;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier09ZPositionAtMilestone7;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier09PhiAtMilestone7;
        sprintf(DebugBuf, "MissionNetworkBattle09::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier09XPositionAtMilestone7 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier09ZPositionAtMilestone7 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier09PhiAtMilestone7 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09XPositionAtMilestone7 = %f", RedTeamCarrier09XPositionAtMilestone7);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09ZPositionAtMilestone7 = %f", RedTeamCarrier09ZPositionAtMilestone7);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09PhiAtMilestone7 = %f", RedTeamCarrier09PhiAtMilestone7);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 140 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier09XPositionAtMilestone8;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier09ZPositionAtMilestone8;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier09PhiAtMilestone8;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier09XPositionAtMilestone8;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier09ZPositionAtMilestone8;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier09PhiAtMilestone8;
        sprintf(DebugBuf, "MissionNetworkBattle09::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier09XPositionAtMilestone8 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier09ZPositionAtMilestone8 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier09PhiAtMilestone8 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09XPositionAtMilestone8 = %f", RedTeamCarrier09XPositionAtMilestone8);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09ZPositionAtMilestone8 = %f", RedTeamCarrier09ZPositionAtMilestone8);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09PhiAtMilestone8 = %f", RedTeamCarrier09PhiAtMilestone8);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
        ...
        sprintf(DebugBuf, "MissionNetworkBattle09::processtimer(): MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
    }
    ...
    if (MissionStateNetworkBattle == 160 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier09XPositionAtMilestone9;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier09ZPositionAtMilestone9;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier09PhiAtMilestone9;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier09XPositionAtMilestone9;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier09ZPositionAtMilestone9;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier09PhiAtMilestone9;
        sprintf(DebugBuf, "MissionNetworkBattle09::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier09XPositionAtMilestone9 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier09ZPositionAtMilestone9 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier09PhiAtMilestone9 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09XPositionAtMilestone9 = %f", RedTeamCarrier09XPositionAtMilestone9);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09ZPositionAtMilestone9 = %f", RedTeamCarrier09ZPositionAtMilestone9);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09PhiAtMilestone9 = %f", RedTeamCarrier09PhiAtMilestone9);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 180 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier09XPositionAtMilestone10;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier09ZPositionAtMilestone10;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier09PhiAtMilestone10;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier09XPositionAtMilestone10;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier09ZPositionAtMilestone10;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier09PhiAtMilestone10;
        sprintf(DebugBuf, "MissionNetworkBattle09::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier09XPositionAtMilestone10 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier09ZPositionAtMilestone10 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier09PhiAtMilestone10 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09XPositionAtMilestone10 = %f", RedTeamCarrier09XPositionAtMilestone10);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09ZPositionAtMilestone10 = %f", RedTeamCarrier09ZPositionAtMilestone10);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer() RedTeamCarrier09PhiAtMilestone10 = %f", RedTeamCarrier09PhiAtMilestone10);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle09::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    for (MissionAircraftNumber = 1; MissionAircraftNumber <= 10; MissionAircraftNumber++) {
        ...
        if (ThreeDObjects[0]->explode > 500 * timestep) {
            ...
            display((char*)"MissionNetworkBattle09::processtimer(): Player plane is dead and player has waited for program to exit. Invoking game_quit().", LOG_MOST);
        ...
        if (!ThreeDObjects[MissionAircraftNumber]->active && (myrandom(10000) > 9990)) { //  Get here 0.5% of the time after any other plane explodes or crashes. Re-spawn destroyed aircraft.
            ...
            //
            sprintf(DebugBuf, "MissionNetworkBattle09::ProcessTimer() re-spawning aircraft #%d.", MissionAircraftNumber);
            display(DebugBuf, LOG_MOST);
            //
            ...
            if (ThreeDObjects[MissionAircraftNumber]->Sentient > 3) {//  Get here if the destroyed aircraft was piloted by a Sentient. Some extra steps are needed.
                ...
                MissionNetworkBattle09PriorAircraft[MissionAircraftNumber] = ThreeDObjects[MissionAircraftNumber]->id;
         ...
         //
            ...
            sprintf(
                DebugBuf,
                "MissionNetworkBattle09::processTimer() spawning new aircraft %d at X=%f Y=%f Z=%f",
...
// Check to see if the player's aircraft has been destroyed:
    ...
    if (MissionNetworkBattleRadarTimer > 100) { //  Get here 10 times /second.
        ...
        if (ThreeDObjects[MissionObjectCarrierRed1]->active) { //@ Get here if this aircraft carrier has not been destroyed. It can still move.
            ThreeDObjects[MissionObjectCarrierRed1]->phi += MissionObjectCarrierRed1RudderDegreesM09;
        ...
        if (ThreeDObjects[MissionObjectCarrierRed1]->active) { //@ Get here if this aircraft carrier has not been destroyed. It can still move.
            ThreeDObjects[MissionObjectCarrierBlue1]->phi += MissionObjectCarrierBlue1RudderDegreesM09;
        ...
        if (ThreeDObjects[MissionObjectCarrierRed1]->active) { //@ Get here if this aircraft carrier has not been destroyed. It can still move.
            ThreeDObjects[MissionObjectCarrierRed1]->tl->x -=
                (
                    MissionObjectCarrierRed1ThrustM09 * cos(((ThreeDObjects[MissionObjectCarrierRed1]->phi) + 0) * DegreesToRadiansFactor)
                    );
            ThreeDObjects[MissionObjectCarrierRed1]->tl->z -=
                (
                    MissionObjectCarrierRed1ThrustM09 * sin(((ThreeDObjects[MissionObjectCarrierRed1]->phi) + 0) * DegreesToRadiansFactor)
                    );
        }
        //
        ...
        if (ThreeDObjects[MissionObjectCarrierBlue1]->active) { //@ Get here if this aircraft carrier has not been destroyed. It can still move.
            ThreeDObjects[MissionObjectCarrierBlue1]->tl->x -=
                (
                    MissionObjectCarrierBlue1ThrustM09 * cos(((ThreeDObjects[MissionObjectCarrierBlue1]->phi) + 0) * DegreesToRadiansFactor)
                    );
            ThreeDObjects[MissionObjectCarrierBlue1]->tl->z -=
                (
                    MissionObjectCarrierBlue1ThrustM09 * sin(((ThreeDObjects[MissionObjectCarrierBlue1]->phi) + 0) * DegreesToRadiansFactor)
                    );
        }
        //
        ...
        if (MissionChronoMilestone != PriorChronoMilestone) { // Get here within 100 milliseconds of receipt of a new Chrono Milestone message
            sprintf(DebugBuf, "MissionNetworkBattle09(): Detected change in MissionChronoMilestone. Now %d.", MissionChronoMilestone);
            display(DebugBuf, LOG_MOST);
    ...
    if (MissionNetworkBattle09Timer > 1000) { //  Get here once every second.
        MissionNetworkBattle09Timer = 0;
        //
        ...
        NewSystemMessageNeedsScrolling = true;
    } //  end of (MissionNetworkBattle09Timer > 1000)
    ...
    if ((BattleDamageRiskTimer > 5000) || (BattleDamageRiskTimer > (abs)(myrandom(131072)))) { //  Get here at least every 5 seconds, or possibly sooner by random chance
        ...
        if (CalculatedDamageDueToCurrentRisk > 0) { //  Get here once every time we suffer new damage. Log it...
            sprintf(DebugBuf, "MissionNetworkBattle09::processTimer() fplayer->Durability is now %f.", fplayer->Durability);
            display(DebugBuf, LOG_MOST);
    ...
    if (StaticObjectUpdateTimer > 2000) { //  Get here when it's time to update network peers regarding any damaged airfields, etc.
        ...
        if (StaticUpdateSwitcher == 1) { //  Get here if it's time to handle MissionObjectHqBlue
            ...
            if (ThreeDObjects[MissionObjectAirfieldBlue2]->active) { // Get here if this object has NOT been destroyed. Issue Static update of its status.
                ...
                display((char*)"MissionNetworkBattle09::processTimer(): MissionObjectAirfieldBlue2 destroyed. Setting DamageInNetQueue = -0.01.", LOG_MOST);
            }
            ...
            if (ThreeDObjects[MissionObjectAirfieldRed2]->active) { // Get here if this object has NOT been destroyed. Issue Static update of its status.
                ...
                display((char*)"MissionNetworkBattle09::processTimer(): MissionObjectAirfieldRed2 destroyed. Setting DamageInNetQueue = -0.01.", LOG_MOST);
            }
            ...
            if (ThreeDObjects[MissionObjectCarrierBlue1]->active) { // Get here if this object has NOT been destroyed. Issue Static update of its status.
                ...
                display((char*)"MissionNetworkBattle09::processTimer(): MissionObjectCarrierBlue1 destroyed. Setting DamageInNetQueue = -0.01.", LOG_MOST);
            }
            ...
            if (ThreeDObjects[MissionObjectCarrierRed1]->active) { // Get here if this object has NOT been destroyed. Issue Static update of its status.
                ...
                display((char*)"MissionNetworkBattle09::processTimer(): MissionObjectCarrierRed1 destroyed. Setting DamageInNetQueue = -0.01.", LOG_MOST);
            }
        }
    ...
    if (NetworkReceiveTimer > NetworkReceiveTimerInterval) { //  Get here every time NetworkReceiveTimer expires. Check for new InPacket:
        ...
        if (BytesReceived == sizeof(LacUdpApiPacket)) { //  Get here if a new InPacket has arrived.
            ...
            display((char*)"MissionNetworkBattle09 BytesReceived=", LOG_NET);
            ...
            if (MissionNetworkBattle09PriorAircraft[InPacket.UdpObjPlayerNumber] != InPacket.UdpObjVehicle) { //  Get here if this network peer is in a different type of aircraft
                //
            ...
            MissionNetworkBattle09PriorAircraft[InPacket.UdpObjPlayerNumber] = InPacket.UdpObjVehicle;
 ...
 //
    ...
    if (NetworkTransmitTimer > NetworkTransmitTimerInterval && !NetworkPlayerKilled) { //  Get here if we're alive and it's time to send a new network API packet.
        ...
        MissionNetworkBattle09RetrieveFirstDamageDescription();
    ...
    if (BlueTeamHasWonTheBattle || RedTeamHasWonTheBattle) { //  Get here if one of the two teams has destroyed BOTH of its opposing airfields and carrier.
        ...
        if (MissionEndingTimer < -200 && CountdownLatch1 == false) { //  Get here 5 seconds after either team wins the battle.
            display((char*)"MissionNetworkBattle09::processtimer() Playing audio file MissionEndingInstrumental.wav", LOG_MOST);
        ...
        if (MissionEndingTimer < -1000 && CountdownLatch2 == false) { //  Get here 10 seconds after either team wins the battle.
            display((char*)"MissionNetworkBattle09::processtimer() Playing audio file MissionEndingIn15SecCountdown.wav", LOG_MOST);
    ...
    if (MissionEndingTimer2) { //  Get here many times, but only after the "countdown warning audio" has begun playing.
        ...
        if (MissionEndingTimer2 < 1000) { //  Get here 16 seconds after "Countdown warning audio" started.
            ...
            display((char*)"MissionNetworkBattle09::processtimer(): Mission ending now.", LOG_MOST);
            fplayer->Durability = -1.0; //  Signal Destruction of player and end the mission.
        }
    }
    return 0;
} //  end MissionNetworkBattle09::processtimer (Uint32 dt)
...
//  here.
//
void MissionNetworkBattle09::draw() {
    if (timer >= 0 && timer <= 50 * timestep) {
        font1->drawTextCentered(0, 12, -2, name, &textcolor);
    }
} //  end MissionNetworkBattle09::draw ()
...
bool MissionNetworkBattle09RetrieveFirstDamageDescription() {
    int Mission3dObject;
    display((char*)"MissionNetworkBattle09RetrieveFirstDamageDescription()", LOG_NET);
    ...
    DamageToClaim = 0.0;
    return (false);
} //  end MissionNetworkBattle09RetrieveFirstDamageDescription()
