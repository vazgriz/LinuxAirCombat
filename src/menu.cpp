...
CColor menu_colblack (0, 0, 0, 200);

extern bool EnterPressed;
extern bool SpaceBarPressed;
...
void Component::execFunction (int button)
    ...
    display ((char *)"Function entry: Component::execFunction()", LOG_MOST);
    if (func)
        {
        if (EnterPressed || SpaceBarPressed)
           { 
           //display ((char *)"Component::execFunction() ENTER or SPACEBAR pressed.", LOG_MOST);
           count++;
           sprintf (DebugBuf, "Component::execFunction() count = %d", count);
           ...
           { 
           //display ((char *)"Component::execFunction() Mouse clicked.", LOG_MOST);
           func (this, button);
           count = 0;
           }
        }
