...
int MissionNetworkBattle10::processtimer (Uint32 dt)
    ...
    if (MissionStateNetworkBattle == 2 && (timer > PriorStateEndTimer +1100))
       ...
       //
       if (MyNetworkId%2)
          { //  RedTeam MissionNetworkBattle10
          if (ThreeDObjects[MissionObjectHqRed]->Durability < ThreeDObjects[MissionObjectHqRed]->maxDurability * 0.4)
             ...
             if (fplayer->HistoricPeriod > 1)
                { //  Get here if the player is flying a late-war or postwar aircraft in this MissionNetworkBattle10
          ...
          { //  BlueTeam MissionNetworkBattle10
    ...
    if (MissionNetworkBattle10Timer > 1000)
    ...
    if (NetworkReceiveTimer > NetworkReceiveTimerInterval )
       ...
       if (BytesReceived == sizeof (LacUdpApiPacket))
          ...
          if (MissionNetworkBattle10PriorAircraft[InPacket.UdpObjPlayerNumber] != InPacket.UdpObjVehicle)
