...
//
//  This file implements "MissionNetworkBattle10".
//
...
//
float RedTeamCarrier10XPositionAtMilestone1 = 272.105042;
float RedTeamCarrier10ZPositionAtMilestone1 = -76.429771;
float RedTeamCarrier10PhiAtMilestone1 = 246.202545;
float RedTeamCarrier10XPositionAtMilestone2 = 260.318420;
float RedTeamCarrier10ZPositionAtMilestone2 = -136.597427;
float RedTeamCarrier10PhiAtMilestone2 = 315.804138;
float RedTeamCarrier10XPositionAtMilestone3 = 266.714844;
float RedTeamCarrier10ZPositionAtMilestone3 = -66.925232;
float RedTeamCarrier10PhiAtMilestone3 = 234.528992;
float RedTeamCarrier10XPositionAtMilestone4 = 198.952469;
float RedTeamCarrier10ZPositionAtMilestone4 = -49.964832;
float RedTeamCarrier10PhiAtMilestone4 = 153.413849;
float RedTeamCarrier10XPositionAtMilestone5 = 171.683975;
float RedTeamCarrier10ZPositionAtMilestone5 = -114.148750;
float RedTeamCarrier10PhiAtMilestone5 = 72.458717;
float RedTeamCarrier10XPositionAtMilestone6 = 231.078461;
float RedTeamCarrier10ZPositionAtMilestone6 = -151.122269;
float RedTeamCarrier10PhiAtMilestone6 = 351.185089;
float RedTeamCarrier10XPositionAtMilestone7 = 276.633148;
float RedTeamCarrier10ZPositionAtMilestone7 = -98.321991;
float RedTeamCarrier10PhiAtMilestone7 = 270.229950;
float RedTeamCarrier10XPositionAtMilestone8 = 230.909607;
float RedTeamCarrier10ZPositionAtMilestone8 = -44.914185;
float RedTeamCarrier10PhiAtMilestone8 = 188.474792;
float RedTeamCarrier10XPositionAtMilestone9 = 171.672470;
float RedTeamCarrier10ZPositionAtMilestone9 = -81.931099;
float RedTeamCarrier10PhiAtMilestone9 = 107.359657;
float RedTeamCarrier10XPositionAtMilestone10 = 198.961212;
float RedTeamCarrier10ZPositionAtMilestone10 = -146.105331;
float RedTeamCarrier10PhiAtMilestone10 = 26.405413;

float BlueTeamCarrier10XPositionAtMilestone1 = -239.394958;
float BlueTeamCarrier10ZPositionAtMilestone1 = -76.429771;
float BlueTeamCarrier10PhiAtMilestone1 = 246.202545;
float BlueTeamCarrier10XPositionAtMilestone2 = -251.181580;
float BlueTeamCarrier10ZPositionAtMilestone2 = -136.597427;
float BlueTeamCarrier10PhiAtMilestone2 = 315.804138;
float BlueTeamCarrier10XPositionAtMilestone3 = -244.785156;
float BlueTeamCarrier10ZPositionAtMilestone3 = -66.925232;
float BlueTeamCarrier10PhiAtMilestone3 = 234.528992;
float BlueTeamCarrier10XPositionAtMilestone4 = -312.547516;
float BlueTeamCarrier10ZPositionAtMilestone4 = -49.964832;
float BlueTeamCarrier10PhiAtMilestone4 = 153.413849;
float BlueTeamCarrier10XPositionAtMilestone5 = -339.816040;
float BlueTeamCarrier10ZPositionAtMilestone5 = -114.148750;
float BlueTeamCarrier10PhiAtMilestone5 = 72.458717;
float BlueTeamCarrier10XPositionAtMilestone6 = -280.421539;
float BlueTeamCarrier10ZPositionAtMilestone6 = -151.122269;
float BlueTeamCarrier10PhiAtMilestone6 = 351.185089;
float BlueTeamCarrier10XPositionAtMilestone7 = -234.866852;
float BlueTeamCarrier10ZPositionAtMilestone7 = -98.321991;
float BlueTeamCarrier10PhiAtMilestone7 = 270.229950;
float BlueTeamCarrier10XPositionAtMilestone8 = -280.590393;
float BlueTeamCarrier10ZPositionAtMilestone8 = -44.914185;
float BlueTeamCarrier10PhiAtMilestone8 = 188.474792;
float BlueTeamCarrier10XPositionAtMilestone9 = -339.827545;
float BlueTeamCarrier10ZPositionAtMilestone9 = -81.931099;
float BlueTeamCarrier10PhiAtMilestone9 = 107.359657;
float BlueTeamCarrier10XPositionAtMilestone10 = -312.538788;
float BlueTeamCarrier10ZPositionAtMilestone10 = -146.105331;
float BlueTeamCarrier10PhiAtMilestone10 = 26.405413;

float MissionObjectCarrierBlue1RudderDegreesM10 = 0.16;
float MissionObjectCarrierBlue1ThrustM10 = 0.15;
float MissionObjectCarrierRed1RudderDegreesM10 = 0.16;
float MissionObjectCarrierRed1ThrustM10 = 0.15;

//
// Mission-specific code commences here:
//
MissionNetworkBattle10::MissionNetworkBattle10() {
    //
    ...
    //
    display((char*)"MissionNetworkBattle10::MissionNetworkBattle10()", LOG_MOST);
    id = MISSION_NETWORKBATTLE10;
    if ((NetworkMode & 1) == 0) {
        strncpy(name, "WRONG NETWORK MODE!", 1024);
        strncpy(briefing, "LACCONFIG.TXT FILE MUST SET MODE 1, 3, OR 5 AND A SERVER ADDRESS.", 1024);
    } else {
        strncpy(name, "NETWORK MISSION 10 (BETA TEST)", 1024);
    ...
    if ((NetworkMode & 1) == 1) { //  ClientServer mode requires only a single UDP port, used both for sending and receiving
        display((char*)"Attempting MissionNetworkBattle10 in ClientServer Network mode.", LOG_NET);
        if (OpenClientUdpSocket() == 0) { //  Get here if we were able to open the required ClientServer UDP Socket
            display((char*)"MissionNetworkBattle10 ClientServer mode succesfully opened ClientUDP socket", LOG_NET);
            ConfigureClientUdpSocket();
        } else { //  Get here if we were unable to open the required ClientUDP socket
            display((char*)"MissionNetworkBattle10 ClientServer mode unable to open ClientUDP socket.", LOG_NET);
        }
    } else {
    ...
    //
    event_CommsMacro17();
} //  end MissionNetworkBattle10::MissionNetworkBattle10 ()

void MissionNetworkBattle10::start() {
    ...
    //
    if (!(NetworkMode & 16)) {
        //popen("espeak -p 10 -a 66  -s 160 \"Welcome to Net Mission 10! This is an experimental, new mission, still under development. At present it is bigger and more sophisticated than any of our three classic multi-player missions. Victory requires destruction of two opposing airfields.\"", "r");
    }
    MissionStateNetworkBattle = 0;
    display((char*)"MissionNetworkBattle10::start()", LOG_MOST);
    ...
    //
    display((char*)"MissionNetworkBattle10::start setting PlayerAircraftType to: ", LOG_MOST);
    ...
    for (i = 1; i <= 10; i++) {
        ...
        MissionNetworkBattle10PriorAircraft[i] = FIGHTER_F4F;
        //
        ...
        //
        sprintf(DebugBuf, "MissionNetworkBattle10::start() initializing Bot #%d", i);
        display(DebugBuf, LOG_MOST);
        sprintf(
            DebugBuf,
            "MissionNetworkBattle10::start() ThreeDObjects [i]->MyMissionPlayerNumber = %d",
...
} //  end MissionNetworkBattle10::start ()

int MissionNetworkBattle10::processtimer(Uint32 dt) {
    ...
    //  this mission:
    //
    MissionNetworkBattle10Timer += DeltaTime; //  Advance by milliseconds
    ...
    if (!MissionRunning) { //  Get here if this is the FIRST pass through processtimer().
        ...
        */
        ...
        if (fplayer->missiles[0] >= 4 || fplayer->id == FIGHTER_D3A || fplayer->id == BOMBER_B5N) { //  Heavy bombers need more initial altitude and distance to avoid stalling and crashing...
            fplayer->tl->y += 60;
            sprintf(DebugBuf, "MissionNetworkBattle10::processtimer() Heavy bomber launching. AirfieldRequested = %d", AirfieldRequested);
            display(DebugBuf, LOG_MOST);
            if (AirfieldRequested >= 3) { //  Get here if launching from the most remote airfield (in a heavy bomber).
                display((char*)"MissionNetworkBattle10::processtimer() Increasing heavy bomber spawn altitude from Field 4", LOG_MOST);
 ...
 //
    ...
    if (timer > 10000 && MissionStateNetworkBattle == 0 && NetworkTransmitTimer >= NetworkTransmitTimerInterval) { //  Only get here once, 10 seconds into the mission, as we've just begun transmitting OutPackets
        ...
        MissionObjectCarrierRed1RudderDegreesM10 = 0.16;
        MissionObjectCarrierRed1ThrustM10 = 0.150;
    ...
    if (MissionStateNetworkBattle == 2 && (timer > PriorStateEndTimer + 1100)) { //  Only get here once, 1100 sec after MissionStateNetworkBattle
        //  advances to "2":
        //
        ...
        //
        if (MyNetworkId % 2) { //  RedTeam MissionNetworkBattle10
            if (ThreeDObjects[MissionObjectHqRed]->Durability < ThreeDObjects[MissionObjectHqRed]->maxDurability * 0.4) { //  Get here if player's RedTeam HQ is heavily damaged. Diminish fuel/armament for late-war aircraft.
                display((char*)"MissionNetworkBattle10 state 2: Player's RedTeam HQ is heavily damaged.", LOG_MOST);
                if (fplayer->HistoricPeriod > 1) { //  Get here if the player is flying a late-war or postwar aircraft in this MissionNetworkBattle10
                    ...
                    for (i2 = 0; i2 < missiletypes; i2++) {
                        if (i2 == 0) { //  Rack0 = BOMB01
                            ...
                            display((char*)"MissionNetworkBattle10::processtimer() diminishing RedTeam late-war bomb load due to heavy HQ airfield damage", LOG_MOST);
                        }
                        if (i2 == 5) { //  Rack5 = DFM Rockets
                            fplayer->missiles[i2] /= 3;
                            display((char*)"MissionNetworkBattle10::processtimer() diminishing RedTeam late-war rocket load due to heavy HQ airfield damage", LOG_MOST);
                        }
                    }
                ...
                display((char*)"MissionNetworkBattle10 state 1: Player's RedTeam HQ is NOT heavily damaged.", LOG_MOST);
                sprintf(SystemMessageBufferA, "OUR HQ FACILITIES PERMIT FULL FUEL/ORDNANCE.");
                NewSystemMessageNeedsScrolling = true;
            }
        } else { //  BlueTeam MissionNetworkBattle10
            if (ThreeDObjects[MissionObjectHqBlue]->Durability < ThreeDObjects[MissionObjectHqBlue]->maxDurability * 0.4) { //  Get here if player's BlueTeam HQ is heavily damaged. Diminish fuel/armament for late-war aircraft.
                if (fplayer->HistoricPeriod > 1) { //  Get here if the player is flying a late-war or postwar aircraft in this MissionNetworkBattle10
                    ...
                    for (i2 = 0; i2 < missiletypes; i2++) {
                        if (i2 == 0) { //  Rack0 = BOMB01
                            fplayer->missiles[i2] /= 3;
                            display((char*)"MissionNetworkBattle10::processtimer() diminishing BlueTeam late-war bomb load due to heavy HQ airfield damage", LOG_MOST);
                        }
                        if (i2 == 5) { //  Rack5 = DFM Rockets
                            fplayer->missiles[i2] /= 3;
                            display((char*)"MissionNetworkBattle10::processtimer() diminishing BlueTeam late-war rocket load due to heavy HQ airfield damage", LOG_MOST);
                        }
                    }
                } else { //  Get here if flying an early-war aircraft.
                    sprintf(SystemMessageBufferA, "WE HAVE FUEL/ORDNANCE FOR THAT AIRCRAFT.");
    ...
    if (MissionStateNetworkBattle == 5 && (timer > PriorStateEndTimer + 3300)) { //  Only get here once, 3300 sec after MissionStateNetworkBattle
        //  advances to "5":
    ...
    //  Mumble channels, etc.
    //
    if (MissionStateNetworkBattle == 13 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "13":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 14 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "14":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 15 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "15":
        //
        //
        ...
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier10XPositionAtMilestone1;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier10ZPositionAtMilestone1;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier10PhiAtMilestone1;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier10XPositionAtMilestone1;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier10ZPositionAtMilestone1;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier10PhiAtMilestone1;
        sprintf(DebugBuf, "MissionNetworkBattle10::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        MissionStateNetworkBattle = 16;
        sprintf(DebugBuf, "MissionNetworkBattle10::processtimer()aa: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        if (MissionCommander == MyNetworkId) { // Get here if the current player is the MissionCommander
            //
        ...
        * use:
        RedTeamCarrier10XPositionAtMilestone1 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier10ZPositionAtMilestone1 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier10PhiAtMilestone1 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10XPositionAtMilestone1 = %f", RedTeamCarrier10XPositionAtMilestone1);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10ZPositionAtMilestone1 = %f", RedTeamCarrier10ZPositionAtMilestone1);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10PhiAtMilestone1 = %f", RedTeamCarrier10PhiAtMilestone1);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
        // the mission advancing through this MissionState, we adjust "RudderDegrees"
        // and "Thrust" variables here:
    ...
    if (MissionStateNetworkBattle == 16 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "16":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 17 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "17":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 18 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "18":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 19 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "19":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 20 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "20":
        //
        //
        // We choose this MissionState as a MissionChronoMilestone.
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier10XPositionAtMilestone2;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier10ZPositionAtMilestone2;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier10PhiAtMilestone2;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier10XPositionAtMilestone2;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier10ZPositionAtMilestone2;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier10PhiAtMilestone2;
        sprintf(DebugBuf, "MissionNetworkBattle10::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier10XPositionAtMilestone2 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier10ZPositionAtMilestone2 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier10PhiAtMilestone2 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10XPositionAtMilestone2 = %f", RedTeamCarrier10XPositionAtMilestone2);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10ZPositionAtMilestone2 = %f", RedTeamCarrier10ZPositionAtMilestone2);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10PhiAtMilestone2 = %f", RedTeamCarrier10PhiAtMilestone2);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 21 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "21":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 22 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "22":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 23 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "23":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 24 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "24":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 25 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "25":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 26 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "26":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 27 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "27":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 28 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "28":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 29 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "29":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 30 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "30":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 31 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "31":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 32 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "32":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 33 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "33":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 34 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "34":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 35 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "35":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 36 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "36":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 37 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "37":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 38 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "38":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 39 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "39":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 40 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "40":
        //
        //
        // We choose this MissionState as a MissionChronoMilestone.
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier10XPositionAtMilestone3;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier10ZPositionAtMilestone3;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier10PhiAtMilestone3;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier10XPositionAtMilestone3;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier10ZPositionAtMilestone3;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier10PhiAtMilestone3;
        sprintf(DebugBuf, "MissionNetworkBattle10::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier10XPositionAtMilestone3 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier10ZPositionAtMilestone3 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier10PhiAtMilestone3 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10XPositionAtMilestone3 = %f", RedTeamCarrier10XPositionAtMilestone3);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10ZPositionAtMilestone3 = %f", RedTeamCarrier10ZPositionAtMilestone3);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10PhiAtMilestone3 = %f", RedTeamCarrier10PhiAtMilestone3);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 41 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "41":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 42 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "42":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 43 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "43":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 44 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "44":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 45 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "45":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 46 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "46":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 47 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "47":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 48 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "48":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 49 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "49":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 50 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "50":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 51 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "51":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 52 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "52":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 53 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "53":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 54 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "54":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 55 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "55":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 56 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "56":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 57 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "57":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 58 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "58":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 59 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "59":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 60 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "60":
        //
        //
        // We choose this MissionState as a MissionChronoMilestone.
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier10XPositionAtMilestone4;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier10ZPositionAtMilestone4;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier10PhiAtMilestone4;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier10XPositionAtMilestone4;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier10ZPositionAtMilestone4;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier10PhiAtMilestone4;
        sprintf(DebugBuf, "MissionNetworkBattle10::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier10XPositionAtMilestone4 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier10ZPositionAtMilestone4 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier10PhiAtMilestone4 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10XPositionAtMilestone4 = %f", RedTeamCarrier10XPositionAtMilestone4);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10ZPositionAtMilestone4 = %f", RedTeamCarrier10ZPositionAtMilestone4);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10PhiAtMilestone4 = %f", RedTeamCarrier10PhiAtMilestone4);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 61 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "61":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 62 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "62":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 63 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "63":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 64 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "64":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 65 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "65":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 66 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "66":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 67 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "67":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 68 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "68":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 69 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "69":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 70 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "70":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 71 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "71":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 72 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "72":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 73 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "73":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 74 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "74":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 75 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "75":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 76 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "76":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 77 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "77":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 78 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "78":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 79 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "79":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 80 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "80":
        //
        //
        // We choose this MissionState as a MissionChronoMilestone.
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier10XPositionAtMilestone5;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier10ZPositionAtMilestone5;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier10PhiAtMilestone5;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier10XPositionAtMilestone5;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier10ZPositionAtMilestone5;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier10PhiAtMilestone5;
        sprintf(DebugBuf, "MissionNetworkBattle10::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier10XPositionAtMilestone5 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier10ZPositionAtMilestone5 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier10PhiAtMilestone5 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10XPositionAtMilestone5 = %f", RedTeamCarrier10XPositionAtMilestone5);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10ZPositionAtMilestone5 = %f", RedTeamCarrier10ZPositionAtMilestone5);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10PhiAtMilestone5 = %f", RedTeamCarrier10PhiAtMilestone5);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 81 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "81":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 82 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "82":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 83 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "83":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 84 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "84":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 85 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "85":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 86 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "86":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 87 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "87":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 88 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "88":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 89 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "89":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 90 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "90":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 91 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "91":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 92 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "92":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 93 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "93":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 94 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "94":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 95 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "95":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 96 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "96":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 97 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "97":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 98 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "98":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 99 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "99":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 100 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "100":
        //
        //
        // We choose this MissionState as a MissionChronoMilestone.
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier10XPositionAtMilestone6;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier10ZPositionAtMilestone6;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier10PhiAtMilestone6;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier10XPositionAtMilestone6;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier10ZPositionAtMilestone6;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier10PhiAtMilestone6;
        sprintf(DebugBuf, "MissionNetworkBattle10::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier10XPositionAtMilestone6 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier10ZPositionAtMilestone6 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier10PhiAtMilestone6 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10XPositionAtMilestone6 = %f", RedTeamCarrier10XPositionAtMilestone6);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10ZPositionAtMilestone6 = %f", RedTeamCarrier10ZPositionAtMilestone6);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10PhiAtMilestone6 = %f", RedTeamCarrier10PhiAtMilestone6);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 101 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "101":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 102 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "102":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 103 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "103":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 104 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "104":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 105 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "105":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 106 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "106":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 107 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "107":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 108 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "108":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 109 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "109":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 110 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "110":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 111 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "111":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 112 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "112":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 113 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "113":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 114 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "114":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 115 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "115":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 116 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "116":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 117 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "117":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 118 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "118":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 119 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "119":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 120 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "120":
        //
        //
        // We choose this MissionState as a MissionChronoMilestone.
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier10XPositionAtMilestone7;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier10ZPositionAtMilestone7;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier10PhiAtMilestone7;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier10XPositionAtMilestone7;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier10ZPositionAtMilestone7;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier10PhiAtMilestone7;
        sprintf(DebugBuf, "MissionNetworkBattle10::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier10XPositionAtMilestone7 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier10ZPositionAtMilestone7 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier10PhiAtMilestone7 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10XPositionAtMilestone7 = %f", RedTeamCarrier10XPositionAtMilestone7);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10ZPositionAtMilestone7 = %f", RedTeamCarrier10ZPositionAtMilestone7);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10PhiAtMilestone7 = %f", RedTeamCarrier10PhiAtMilestone7);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 121 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "121":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 122 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "122":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 123 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "123":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 124 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "124":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 125 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "125":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 126 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "126":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 127 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "127":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 128 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "128":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 129 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "129":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 130 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "130":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 131 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "131":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 132 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "132":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 133 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "133":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 134 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "134":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 135 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "135":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 136 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "136":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 137 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "137":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 138 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "138":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 139 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "139":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 140 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "140":
        //
        //
        // We choose this MissionState as a MissionChronoMilestone.
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier10XPositionAtMilestone8;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier10ZPositionAtMilestone8;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier10PhiAtMilestone8;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier10XPositionAtMilestone8;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier10ZPositionAtMilestone8;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier10PhiAtMilestone8;
        sprintf(DebugBuf, "MissionNetworkBattle10::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier10XPositionAtMilestone8 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier10ZPositionAtMilestone8 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier10PhiAtMilestone8 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10XPositionAtMilestone8 = %f", RedTeamCarrier10XPositionAtMilestone8);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10ZPositionAtMilestone8 = %f", RedTeamCarrier10ZPositionAtMilestone8);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10PhiAtMilestone8 = %f", RedTeamCarrier10PhiAtMilestone8);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
        ...
        sprintf(DebugBuf, "MissionNetworkBattle10::processtimer(): MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
    }

    if (MissionStateNetworkBattle == 141 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "141":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 142 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "142":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 143 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "143":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 144 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "144":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 145 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "145":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 146 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "146":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 147 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "147":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 148 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "148":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 149 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "149":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 150 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "150":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 151 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "151":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 152 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "152":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 153 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "153":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 154 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "154":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 155 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "155":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 156 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "156":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 157 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "157":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 158 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "158":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 159 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "159":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 160 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "160":
        //
        //
        // We choose this MissionState as a MissionChronoMilestone.
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier10XPositionAtMilestone9;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier10ZPositionAtMilestone9;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier10PhiAtMilestone9;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier10XPositionAtMilestone9;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier10ZPositionAtMilestone9;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier10PhiAtMilestone9;
        sprintf(DebugBuf, "MissionNetworkBattle10::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier10XPositionAtMilestone9 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier10ZPositionAtMilestone9 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier10PhiAtMilestone9 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10XPositionAtMilestone9 = %f", RedTeamCarrier10XPositionAtMilestone9);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10ZPositionAtMilestone9 = %f", RedTeamCarrier10ZPositionAtMilestone9);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10PhiAtMilestone9 = %f", RedTeamCarrier10PhiAtMilestone9);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 161 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "161":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 162 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "162":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 163 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "163":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 164 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "164":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 165 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "165":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 166 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "166":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 167 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "167":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 168 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "168":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 169 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "169":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 170 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "170":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 171 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "171":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 172 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "172":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 173 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "173":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 174 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "174":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 175 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "175":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 176 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "176":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 177 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "177":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 178 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "178":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 179 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "179":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 180 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "180":
        //
        //
        // We choose this MissionState as a MissionChronoMilestone.
        ...
        // according to our hard-coded mission logistics:
        //
        ThreeDObjects[MissionObjectCarrierRed1]->tl->x = RedTeamCarrier10XPositionAtMilestone10;
        ThreeDObjects[MissionObjectCarrierRed1]->tl->z = RedTeamCarrier10ZPositionAtMilestone10;
        ThreeDObjects[MissionObjectCarrierRed1]->phi = RedTeamCarrier10PhiAtMilestone10;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->x = BlueTeamCarrier10XPositionAtMilestone10;
        ThreeDObjects[MissionObjectCarrierBlue1]->tl->z = BlueTeamCarrier10ZPositionAtMilestone10;
        ThreeDObjects[MissionObjectCarrierBlue1]->phi = BlueTeamCarrier10PhiAtMilestone10;
        sprintf(DebugBuf, "MissionNetworkBattle10::processtimer()a: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display(DebugBuf, LOG_MOST);
        ...
        * We are retaining the commented-out code block for future reference, but NOT for ordinary
        * use:
        RedTeamCarrier10XPositionAtMilestone10 = ThreeDObjects[MissionObjectCarrierRed1]->tl->x;
        RedTeamCarrier10ZPositionAtMilestone10 = ThreeDObjects[MissionObjectCarrierRed1]->tl->z;
        RedTeamCarrier10PhiAtMilestone10 = ThreeDObjects[MissionObjectCarrierRed1]->phi;
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10XPositionAtMilestone10 = %f", RedTeamCarrier10XPositionAtMilestone10);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10ZPositionAtMilestone10 = %f", RedTeamCarrier10ZPositionAtMilestone10);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer() RedTeamCarrier10PhiAtMilestone10 = %f", RedTeamCarrier10PhiAtMilestone10);
        display (DebugBuf, LOG_MOST);
        sprintf (DebugBuf, "MissionNetworkBattle10::processtimer()b: MissionStateNetworkBattle = %d", MissionStateNetworkBattle);
        display (DebugBuf,LOG_MOST); */
        // Now, if we want to change heading or thrust of our ships as a consequence of
    ...
    if (MissionStateNetworkBattle == 181 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "181":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 182 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "182":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 183 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "183":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 184 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "184":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 185 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "185":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 186 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "186":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 187 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "187":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 188 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "188":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 189 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "189":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 190 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "190":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 191 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "191":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 192 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "192":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 193 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "193":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 194 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "194":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 195 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "195":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 196 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "196":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 197 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "197":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 198 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "198":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 199 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "199":
        //
        if (!(NetworkMode & 16)) {
    ...
    if (MissionStateNetworkBattle == 200 && (timer > PriorStateEndTimer + 10000)) { //  Only get here once, 10000 ms after MissionStateNetworkBattle
        //  advances to "200":
        //
        if (!(NetworkMode & 16)) {
    ...
    for (MissionAircraftNumber = 1; MissionAircraftNumber <= 10; MissionAircraftNumber++) {
        ...
        if (ThreeDObjects[0]->explode > 500 * timestep) {
            ...
            display((char*)"MissionNetworkBattle10::processtimer(): Player plane is dead and player has waited for program to exit. Invoking game_quit().", LOG_MOST);
        ...
        if (!ThreeDObjects[MissionAircraftNumber]->active && (myrandom(10000) > 9990)) { //  Get here 0.5% of the time after any other plane explodes or crashes. Re-spawn destroyed aircraft.
            ...
            //
            sprintf(DebugBuf, "MissionNetworkBattle10::ProcessTimer() re-spawning aircraft #%d.", MissionAircraftNumber);
            display(DebugBuf, LOG_MOST);
            //
            ...
            if (ThreeDObjects[MissionAircraftNumber]->Sentient > 3) {//  Get here if the destroyed aircraft was piloted by a Sentient. Some extra steps are needed.
                ...
                MissionNetworkBattle10PriorAircraft[MissionAircraftNumber] = ThreeDObjects[MissionAircraftNumber]->id;
         ...
         //
            ...
            sprintf(
                DebugBuf,
                "MissionNetworkBattle10::processTimer() spawning new aircraft %d at X=%f Y=%f Z=%f",
...
// Check to see if the player's aircraft has been destroyed:
    ...
    if (MissionNetworkBattleRadarTimer > 100) { //  Get here 10 times /second.
        ...
        //
        if (ThreeDObjects[MissionObjectRadarHqBlue]->Durability > 200) { //  Get here if the BlueTeam HQ airfield is not too damaged for RADAR Antenna Rotation.
            ThreeDObjects[MissionObjectRadarHqBlue]->phi += 10; //  Rotate the BlueTeam Radar Reflector antenna 10 degrees.
        }
        if (ThreeDObjects[MissionObjectRadarHqBlue]->phi >= 360) { //  If it's rotated beyond 360 degrees, reset it.
            ThreeDObjects[MissionObjectRadarHqBlue]->phi = 0;
        }
        if (ThreeDObjects[MissionObjectRadarHqRed]->Durability > 200) { //  Get here if the RedTeam HQ airfield is not too damaged for RADAR Antenna Rotation.
            ThreeDObjects[MissionObjectRadarHqRed]->phi += 10; //  Rotate the RedTeam Radar Reflector antenna 10 degrees.
        }
        if (ThreeDObjects[MissionObjectRadarHqRed]->phi >= 360) { //  If it's rotated beyond 360 degrees, reset it.
            ThreeDObjects[MissionObjectRadarHqRed]->phi = 0;
        }
        if (ThreeDObjects[MissionObjectRadarBlue2]->Durability > 200) { //  Get here if the BlueTeam HQ airfield is not too damaged for RADAR Antenna Rotation.
            ThreeDObjects[MissionObjectRadarBlue2]->phi += 10; //  Rotate the BlueTeam Radar Reflector antenna 10 degrees.
        }
        if (ThreeDObjects[MissionObjectRadarBlue2]->phi >= 360) { //  If it's rotated beyond 360 degrees, reset it.
            ThreeDObjects[MissionObjectRadarBlue2]->phi = 0;
        }
        if (ThreeDObjects[MissionObjectRadarRed2]->Durability > 200) { //  Get here if the BlueTeam HQ airfield is not too damaged for RADAR Antenna Rotation.
            ThreeDObjects[MissionObjectRadarRed2]->phi += 10; //  Rotate the BlueTeam Radar Reflector antenna 10 degrees.
        }
        if (ThreeDObjects[MissionObjectRadarRed2]->phi >= 360) { //  If it's rotated beyond 360 degrees, reset it.
        ...
        //
        if (ThreeDObjects[MissionObjectCarrierRed1]->active) { //@ Get here if this aircraft carrier has not been destroyed. It can still move.
            ThreeDObjects[MissionObjectCarrierRed1]->phi += MissionObjectCarrierRed1RudderDegreesM10;
        ...
        if (ThreeDObjects[MissionObjectCarrierRed1]->active) { //@ Get here if this aircraft carrier has not been destroyed. It can still move.
            ThreeDObjects[MissionObjectCarrierBlue1]->phi += MissionObjectCarrierBlue1RudderDegreesM10;
        ...
        if (ThreeDObjects[MissionObjectCarrierRed1]->active) { //@ Get here if this aircraft carrier has not been destroyed. It can still move.
            ThreeDObjects[MissionObjectCarrierRed1]->tl->x -=
                (
                    MissionObjectCarrierRed1ThrustM10 * cos(((ThreeDObjects[MissionObjectCarrierRed1]->phi) + 0) * DegreesToRadiansFactor)
                    );
            ThreeDObjects[MissionObjectCarrierRed1]->tl->z -=
                (
                    MissionObjectCarrierRed1ThrustM10 * sin(((ThreeDObjects[MissionObjectCarrierRed1]->phi) + 0) * DegreesToRadiansFactor)
                    );
        }
        //
        // Adjust MissionObjectCarrierBlue1 XZ position if our Thrust is not set at 0:
        //
        if (ThreeDObjects[MissionObjectCarrierBlue1]->active) { //@ Get here if this aircraft carrier has not been destroyed. It can still move.
            ThreeDObjects[MissionObjectCarrierBlue1]->tl->x -=
                (
                    MissionObjectCarrierBlue1ThrustM10 * cos(((ThreeDObjects[MissionObjectCarrierBlue1]->phi) + 0) * DegreesToRadiansFactor)
                    );
            ThreeDObjects[MissionObjectCarrierBlue1]->tl->z -=
                (
                    MissionObjectCarrierBlue1ThrustM10 * sin(((ThreeDObjects[MissionObjectCarrierBlue1]->phi) + 0) * DegreesToRadiansFactor)
                    );
        }
        //
        ...
        //
        if (MissionChronoMilestone != PriorChronoMilestone) { // Get here within 100 milliseconds of receipt of a new Chrono Milestone message
            sprintf(DebugBuf, "MissionNetworkBattle10(): Detected change in MissionChronoMilestone. Now %d.", MissionChronoMilestone);
            display(DebugBuf, LOG_MOST);
    ...
    if (MissionNetworkBattle10Timer > 1000) { //  Get here once every second.
        MissionNetworkBattle10Timer = 0;
        //
        ...
        NewSystemMessageNeedsScrolling = true;
    } //  end of (MissionNetworkBattle10Timer > 1000)
    ...
    if ((BattleDamageRiskTimer > 5000) || (BattleDamageRiskTimer > (abs)(myrandom(131072)))) { //  Get here at least every 5 seconds, or possibly sooner by random chance
        ...
        if (CalculatedDamageDueToCurrentRisk > 0) { //  Get here once every time we suffer new damage. Log it...
            sprintf(DebugBuf, "MissionNetworkBattle10::processTimer() fplayer->Durability is now %f.", fplayer->Durability);
            display(DebugBuf, LOG_MOST);
    ...
    if (MissionTenSecondTimer > 10000) { // Get here once every 10 seconds
        ...
        if (MissionCommanderCandidate > MyNetworkId) { // If any Inpacket of prior 10 seconds came from a player with higher ID than me
            MissionCommander = MissionCommanderCandidate; // Then THAT player is MissionCommander
        } else { // Otherwise, I am the MissionCommander
    ...
    if (StaticObjectUpdateTimer > 2000) { //  Get here when it's time to update network peers regarding any damaged airfields, etc.
        ...
        } else if (StaticUpdateSwitcher == 3) { //  Get here if it's time to handle MissionObjectAirfieldBlue2
            if (ThreeDObjects[MissionObjectAirfieldBlue2]->active) { // Get here if this object has NOT been destroyed. Issue Static update of its status.
                ...
                display((char*)"MissionNetworkBattle10::processTimer(): MissionObjectAirfieldBlue2 destroyed. Setting DamageInNetQueue = -0.01.", LOG_MOST);
            }
        } else if (StaticUpdateSwitcher == 4) { //  Get here if it's time to handle MissionObjectAirfieldRed2
            if (ThreeDObjects[MissionObjectAirfieldRed2]->active) { // Get here if this object has NOT been destroyed. Issue Static update of its status.
                ...
                display((char*)"MissionNetworkBattle10::processTimer(): MissionObjectAirfieldRed2 destroyed. Setting DamageInNetQueue = -0.01.", LOG_MOST);
            }
        } else if (StaticUpdateSwitcher == 5) { //  Get here if it's time to handle MissionObjectCarrierBlue1
            if (ThreeDObjects[MissionObjectCarrierBlue1]->active) { // Get here if this object has NOT been destroyed. Issue Static update of its status.
                ...
                display((char*)"MissionNetworkBattle10::processTimer(): MissionObjectCarrierBlue1 destroyed. Setting DamageInNetQueue = -0.01.", LOG_MOST);
            }
        } else if (StaticUpdateSwitcher == 6) { //  Get here if it's time to handle MissionObjectCarrierRed1
            if (ThreeDObjects[MissionObjectCarrierRed1]->active) { // Get here if this object has NOT been destroyed. Issue Static update of its status.
                ...
                display((char*)"MissionNetworkBattle10::processTimer(): MissionObjectCarrierRed1 destroyed. Setting DamageInNetQueue = -0.01.", LOG_MOST);
            }
        }
    ...
    if (NetworkReceiveTimer > NetworkReceiveTimerInterval) { //  Get here every time NetworkReceiveTimer expires. Check for new InPacket:
        ...
        if (BytesReceived == sizeof(LacUdpApiPacket)) { //  Get here if a new InPacket has arrived.
            ...
            display((char*)"MissionNetworkBattle10 BytesReceived=", LOG_NET);
            ...
            if (MissionNetworkBattle10PriorAircraft[InPacket.UdpObjPlayerNumber] != InPacket.UdpObjVehicle) { //  Get here if this network peer is in a different type of aircraft
                //
            ...
            MissionNetworkBattle10PriorAircraft[InPacket.UdpObjPlayerNumber] = InPacket.UdpObjVehicle;
 ...
 //
    ...
    if (NetworkTransmitTimer > NetworkTransmitTimerInterval && !NetworkPlayerKilled) { //  Get here if we're alive and it's time to send a new network API packet.
        ...
        MissionNetworkBattle10RetrieveFirstDamageDescription();
    ...
    if (BlueTeamHasWonTheBattle || RedTeamHasWonTheBattle) { //  Get here if one of the two teams has destroyed BOTH of its opposing airfields and carrier.
        ...
        if (MissionEndingTimer < -200 && CountdownLatch1 == false) { //  Get here 5 seconds after either team wins the battle.
            display((char*)"MissionNetworkBattle10::processtimer() Playing audio file MissionEndingInstrumental.wav", LOG_MOST);
        ...
        if (MissionEndingTimer < -1000 && CountdownLatch2 == false) { //  Get here 10 seconds after either team wins the battle.
            display((char*)"MissionNetworkBattle10::processtimer() Playing audio file MissionEndingIn15SecCountdown.wav", LOG_MOST);
    ...
    if (MissionEndingTimer2) { //  Get here many times, but only after the "countdown warning audio" has begun playing.
        ...
        if (MissionEndingTimer2 < 1000) { //  Get here 16 seconds after "Countdown warning audio" started.
            ...
            display((char*)"MissionNetworkBattle10::processtimer(): Mission ending now.", LOG_MOST);
            fplayer->Durability = -1.0; //  Signal Destruction of player and end the mission.
        }
    }
    return 0;
} //  end MissionNetworkBattle10::processtimer (Uint32 dt)
...
//  here.
//
void MissionNetworkBattle10::draw() {
    if (timer >= 0 && timer <= 50 * timestep) {
        font1->drawTextCentered(0, 12, -2, name, &textcolor);
    }
} //  end MissionNetworkBattle10::draw ()
...
bool MissionNetworkBattle10RetrieveFirstDamageDescription() {
    int Mission3dObject;
    display((char*)"MissionNetworkBattle10RetrieveFirstDamageDescription()", LOG_NET);
    ...
    DamageToClaim = 0.0;
    return (false);
} //  end MissionNetworkBattle10RetrieveFirstDamageDescription()
