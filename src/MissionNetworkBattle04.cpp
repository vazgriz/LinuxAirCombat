...
int MissionNetworkBattle04::processtimer (Uint32 dt)
    ...
    if (MissionStateNetworkBattle == 2 && (timer > PriorStateEndTimer +1100))
       ...
       //
       if (MyNetworkId%2)
          { //  RedTeam MissionNetworkBattle04
          if (ThreeDObjects[MissionObjectHqRed]->Durability < ThreeDObjects[MissionObjectHqRed]->maxDurability * 0.4)
             ...
             if (fplayer->HistoricPeriod > 1)
                { //  Get here if the player is flying a late-war or postwar aircraft in this MissionNetworkBattle04
          ...
          { //  BlueTeam MissionNetworkBattle04
    ...
    if (MissionNetworkBattle04Timer > 1000)
    ...
    if (NetworkReceiveTimer > NetworkReceiveTimerInterval )
       ...
       if (BytesReceived == sizeof (LacUdpApiPacket))
          ...
          if (MissionNetworkBattle04PriorAircraft[InPacket.UdpObjPlayerNumber] != InPacket.UdpObjVehicle)
